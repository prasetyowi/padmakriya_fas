...
class PurchaseOrder extends ParentController
{
	private $MenuKode;
	...
	public function detail()
	{
		...
		$data['act'] = "detail";
		$data['bank'] = $this->M_PurchaseOrder->Getbank();
		$data['Anggaran'] = $this->M_PurchaseOrder->GetAnggaranDetail2ByYearDepoClient();
	...
	public function search_purchase_request_by_filter()
	{
		...
		$data = $this->M_PurchaseOrder->search_purchase_request_by_filter($tgl1, $tgl2, $perusahaan, $divisi, $status);
