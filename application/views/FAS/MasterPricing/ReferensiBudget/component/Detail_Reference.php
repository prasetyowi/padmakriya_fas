    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3 name="CAPTION-DETAILREFERENSIBUDGET">Detail Referensi Budget</h3>
            </div>
        </div>
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <div class="col-md-8 col-sm-8">
                                <input type="text" id="kode_referensi" class="form-control" name="kode_referensi"
                                    readonly value="<?= $rbid->rb_kode ?>" disabled />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-form-label col-md-3 col-sm-3 label-align"
                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    <input type="text" class="form-control datepicker" name="tgl_promo_awal"
                                        id="tgl_promo_awal" value="<?= $rbid->tgl_awal ?>" disabled>
                                </div>
                                ...
                                <div class="col-sm-3">
                                    <input type="text" class="form-control datepicker" name="tgl_promo_akhir"
                                        id="tgl_promo_akhir" value="<?= $rbid->tgl_akhir ?>" disabled>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        ...
                                        <input type="checkbox" name="tipeBudget" style="transform: scale(1.5);"
                                            id="in_qty" name="in_qty" value="1" onchange="inQty(this)" checked disabled>
                                        &nbsp;<label name="" for="in_qty"> In
                                            Qty</label>
                                        <?php } else { ?>
                                        <input type="checkbox" name="tipeBudget" style="transform: scale(1.5);"
                                            id="in_qty" name="in_qty" value="0" onchange="inQty(this)" disabled>
                                        &nbsp;<label name="" for="in_qty"> In
                                            Qty</label>
                                        <?php } ?>
                                    </div>
                                    <div class="col-sm-4">
                                        ...
                                        <input type="checkbox" name="tipeBudget" style="transform: scale(1.5);"
                                            id="in_value" name="in_value" value="0" onchange="inValue(this)" checked
                                            disabled>
                                        ...
                                        <?php } else { ?>
                                        <input type="checkbox" name="tipeBudget" style="transform: scale(1.5);"
                                            id="in_value" name="in_value" value="0" onchange="inValue(this)" disabled>
                                        &nbsp;<label name="" for="in_value">
                                            <?php } ?>
                                    </div>
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8 col-sm-8">
                                <select id="principle" name="principle" class="form-control select2" style="width:100%"
                                    onchange="GetPrincipleData(this.value)" required disabled>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8 col-sm-8">
                                ...
                                <select id="sku_grup" name="sku_grup" class="form-control select2" style="width:100%"
                                    required disabled>
                                    <option value="1" <?= $rbid->grup_sku == 1 ? ' selected="selected"' : ''; ?>><label
                                            name="">Iya</label>
                                    </option>
                                    <option value="0" <?= $rbid->grup_sku == 0 ? ' selected="selected"' : ''; ?>><label
                            ...
                            <div class="col-md-8 col-sm-8">
                                ...
                                <div class="approval" style="padding-top:6px">
                                    <input type="checkbox" name="pengajuan_approval" style="transform: scale(1.5);"
                                        id="pengajuan_approval" value="1" disabled>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8 col-sm-8">
                                <select id="client_wms" name="client_wms" class="form-control select2"
                                    style="width:100%" required disabled>
                                    <option value="<?= set_value('client') ?>">** <label name="">Pilih
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8 col-sm-8">
                                <textarea class="form-control" name="keterangan" id="keterangan"
                                    disabled><?= $rbid->keterangan ?></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-form-label col-md-3 col-sm-3 label-align"
                            ...
                            <div class="col-md-2 col-sm-2">
                                <input type="number" name="notif_pemakaian" id="notif_pemakaian" class="form-control"
                                    value="<?= $rbid->notif_budget ?>" min="1" max="100" disabled>
                            </div>
        ...
        <div class="row" id="notSku" style="display: none;">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <div class="row">
                            <table id="withoutSkuRead" width="100%" class="table table-striped">
                                <thead>
                                    <tr>
        ...
        <div class="row ro-batch" id="usingSku" style="display: none;">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <div class="row">
                            <table id="withSkuRead" width="100%" class="table table-striped">
                                <thead>
                                    <tr>
                                        <th name="" class="text-center">No</th>
