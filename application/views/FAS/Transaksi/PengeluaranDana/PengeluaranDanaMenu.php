...
<div class="right_col" role="main">
	<div class="">
		<div class="page-title">
			<div class="title_left">
				<h3 name="CAPTION-TRANSAKSIPENGELUARANDANA">Transaksi Pengeluaran Dana</h3>
			</div>
		</div>
	</div>
	...
	<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="x_panel">
				<div class="x_title">
					<h5 name="CAPTION-PENCAIRANTRANSAKSIPENGELUARANDANA">Pencarian Transaksi Pengeluaran Dana</h5>
				</div>
				<div class="x_content">
						...
						<div class="row">
							<div class="col-lg-6 col-md-6 col-sm-6">
								...
								<div class="item form-group">
									...
									<div class="col-lg-6 col-md-6 col-sm-6">
										<select class="form-control select2" name="filter_kategori_biaya" id="filter_kategori_biaya" required>
											<option value="" selected>-- ALL --</option>
											<?php foreach ($kategori_biaya as $item) : ?>
												<option value="<?php echo $item['kategori_biaya_id'] ?>">
													<?php echo $item['kategori_biaya_nama'] ?></option>
											<?php endforeach; ?>
										</select>
									</div>
								</div>
	...
	<div class="row ro-batch" id="do-table">
		...
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="x_panel">
				<div class="x_title">
					<h5 name="CAPTION-DAFTARTRANSAKSIPENGELUARANDANA">Daftar Transaksi Pengeluaran Dana</h5>
					<a class="btn btn-md btn-primary" href="<?php echo base_url('FAS/Transaksi/PengeluaranDana/PengeluaranDanaForm'); ?>" name="CAPTION-BUATTRANSAKSIPENGELUARANDANA">Buat
						Transaksi
						Pengeluaran Dana</a>
					<div class="clearfix"></div>
				</div>
					...
					<table id="tablePengeluaran" width="100%" class="table table-responsive">
						<thead>
							<tr>
								...
								<th name="CAPTION-PEMBAYARAN">Pembayaran</th>
								<th name="CAPTION-NAMAPEMOHON">Nama Pemohon</th>
								...
								<th name="CAPTION-STATUSPOSTING">Status Posting</th>
...
<!-- modal add Pengeluaran dana -->
<div class="modal fade" id="modalPengeluaranDana" role="dialog" data-keyboard="false" data-backdrop="static">
	<div class="modal-dialog modal-xlg">
		<!-- Modal content-->
		<form class="form-horizontal" enctype="multipart/form-data" id="PengeluaranDana">
...
anel">
						...
						<div class="row">
							<div class="form-group">
								<la bel class="control-label col-xs-12 col-sm-2 col-md-2 col-lg-2 col-xl-2" name="CAPTION-FILE">File</label>
