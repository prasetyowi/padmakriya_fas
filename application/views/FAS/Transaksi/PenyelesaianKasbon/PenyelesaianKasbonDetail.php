							...
							<div class="tab-pane active" id="event">
								<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
									...
									<div class="form-group">
										...
										<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8 col-xl-8">
											<textarea id="add_keterangan" name="add_keterangan" class="txtjudul form-control" style="height: 100px; width: 100%; resize: none;" disabled readonly><?= $penyelesaian_kasbon->penyelesaian_kasbon_keterangan ?></textarea>
										</div>
									</div>
								</div>
								<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
							...
							<tbody>
								<?php foreach ($penyelesaian_kasbon_detail as $i => $row) : ?>
									<tr>
										...
										<td style='vertical-align:middle; text-align: center;'><input disabled readonly type="text" id="txtname-<?= $i + 1 ?>" class="form-control" value="<?= $row['nama_pengeluaran_detail'] ?>"></td>
										<td style='vertical-align:middle; text-align: center;'><input disabled readonly type="text" class="form-control" onkeypress="return event.charCode >= 48 && event.charCode <= 57" id="qty-aktual-<?= $i + 1 ?>" onkeyup="ubahQty('<?= $i + 1 ?>')" value="<?= (int)$row['qty_pengeluaran_detail'] == null ? 0 : (int)$row['qty_pengeluaran_detail'] ?>"></td>
										<td style='vertical-align:middle; text-align: center;'><input disabled readonly type=" text" class="form-control" onkeypress="return event.charCode >= 48 && event.charCode <= 57" id="nominal-aktual-<?= $i + 1 ?>" onkeyup="ubahNominal('<?= $i + 1 ?>')" value="<?= Round($row['harga_pengeluaran_detail']) == null ? 0 : Round($row['harga_pengeluaran_detail']) ?>"></td>
