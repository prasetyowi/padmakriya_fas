    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3 name="CAPTION-FORMANGGARANTAHUNAN">Form Anggaran Tahunan</h3>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h5 name="CAPTION-FORMANGGARAN">Form Anggaran</h5>
                    </div>
                    <div class="x_content">
                        <form id="form-filter-do" class="form-horizontal form-label-left">
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <input type="text" class="form-control input-date-start"
                                                ...
                                                value="<?= $anggaran->anggaran_kode ?>" readonly>
                                            <input type="hidden" class="form-control input-date-start" name="id_header"
                                                id="id_header" value="<?= $anggaran->anggaran_id ?>" readonly>
                                        </div>
                                    </div>
                                    <div class="item form-group">
                                        <label class="col-form-label col-md-6 col-sm-6 label-align"
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <input type="text" class="form-control input-date-start" name="tahun"
                                                id="tahun" value="<?= $anggaran->anggaran_tahun ?>" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <input type="text" class="form-control" name="jumlah_level"
                                                id="jumlah_level" value="<?= $anggaran->anggaran_jumlah_level ?>"
                                                readonly>
                                        </div>
                                    </div>
                                    <!-- <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <select class="form-control select2" name="perusahaan" id="perusahaan" required>
                            ...
                            <div class="x_title">
                                <h5 name="CAPTION-BUATANGGARANTAHUNAN">Buat Anggaran Tahunan</h5>
                            </div>
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <input type="text" class="form-control input-date-start"
                                                name="no_doc_detail" id="no_doc_detail" placeholder="(Auto)" readonly>
                                        </div>
                                    </div>
                                    <div class="item form-group">
                                        <label class="col-form-label col-md-6 col-sm-6 label-align"
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <input type="text" class="form-control" name="anggaran_detail_status"
                                                id="anggaran_detail_status" value="Draft" readonly>
                                        </div>
                                    </div>
                                    <div class="item form-group">
                                        <label class="col-form-label col-md-6 col-sm-6 label-align"
                                        ...
                                        <div class="col-md-2 col-sm-2">
                                            <input type="checkbox" class="form-control" name="approval" id="approval"
                                                onclick="addApproval()">
                                        </div>
                                    </div>
                                </div>
