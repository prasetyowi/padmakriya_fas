<script>
                ...
                if (data.length > 0) {
                    $.each(data, function(index, value) {
                        ...
                        if (value.anggaran_detail_2_level == 0) {
                            ...
                            if (listBudget != []) {
                                arrDataBudget.push({
                                    ...
                                    budget: listBudget,
                                    unlimit: value.anggaran_detail_2_is_unlimited,
                                })
                        ...
                        arrDataD.push({
                            ...
                            unlimit: parseInt(value.anggaran_detail_2_is_unlimited) || 0,
                        })
    ...
    $('#saveData').click(function(e) {
        ...
        let resultInduk = arrDataD.filter(value => {
            ...
            if (value.budget <= 0 && value.unlimit == false || value.budget <= 0 && value.unlimit == 0) {
                mess = false;
            } else if (value.budget <= 0 && value.unlimit == true || value.unlimit == 1) {
                mess = true;
            } else {
                mess = true
            }
        ...
        Swal.fire({
            ...
            if (result.value == true) {
                $.ajax({
                    type: 'POST',
                    url: "<?= base_url('FAS/Barjas/Anggaran/UpdateAnggaranDetail') ?>",
                    data: {
                        anggaran_id: anggaran_id,
                        anggaran_detail_status: anggaran_detail_status,
                        anggaran_detail_id: anggaran_detail_id,
                        anggaran_detail_kode: anggaran_detail_kode,
    ...
    function viewTableBudget(kode_anggaran) {
        ...
        if (arrDataBudget.length > 0) {
            ...
            if (index_data >= 0) {
                ...
                let disabled = "";
                if (isunlimit == true || isunlimit == "true" || isunlimit == 1) {
                    $("#cbunlimit").prop("checked", true);
                    disabled = "disabled";
                } else {
