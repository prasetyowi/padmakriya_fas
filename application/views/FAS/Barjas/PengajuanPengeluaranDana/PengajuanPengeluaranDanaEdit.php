			...
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
								...
								<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 " id="anylist">
									<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
										...
										<div class="item form-group">
											<label class="control-label col-xs-12 col-sm-4 col-md-4 col-lg-4 col-xl-4 label-align" name="CAPTION-KODE">Kode</label>
										...
										<div class="form-group">
											...
											<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8 col-xl-8">
												<select class="form-control custom-select" name="add_perusahaan" id="add_perusahaan" required <?= count($Perusahaan) == 1 ? 'disabled readonly' : '' ?>>
										...
										<div class="form-group">
											...
											<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8 col-xl-8">
												<select id="add_jenis_pengadaan" name="add_jenis_pengadaan" class="form-control custom-select">
										...
										<div class="form-group">
											...
											<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8 col-xl-8">
												<input type="text" id="add_nodocpo" name="add_nodocpo" class="txtjudul form-control" value="<?= $pengajuan_dana->pengajuan_dana_no_doc_po ?>" />
											</div>
										</div>
										...
										<div class="form-group">
											<label class="control-label col-xs-12 col-sm-4 col-md-4 col-lg-4 col-xl-4" name="CAPTION-TANGGALDIBUTUHKAN">Tanggal
												DIbutuhkan</label>
											<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8 col-xl-8">
												<input type="date" id="add_tanggal" name="add_tanggal" class="txtselected_date form-control" value="<?= $pengajuan_dana->tgl_dibutuhkan == '' ? date('Y-m-d') : $pengajuan_dana->tgl_dibutuhkan ?>" readonly />
											</div>
										</div>
										<div class="form-group" style="display: none;">
										...
										<div class="form-group" style="display: none;">
											...
											<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8 col-xl-8">
												<select id="add_tipe_biaya" name="add_tipe_biaya" class="form-control custom-select">
													<option value="">-- <label name="CAPTION-TIPEBIAYA">Pilih
															Tipe</label> --</option>
									...
									<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
										<div class="form-group">
											...
											<div class="col-xs-12 col-sm-6 col-md-8 col-lg-8 col-xl-8">
												<input type="text" id="approval_anggaran_detail_tahun" name="approval_anggaran_detail_tahun" class="txtjudul form-control" value="<?= $pengajuan_dana->tahun_pengajuan_dana_dibutuhkan ?>" disabled />
									...
									<div class="form-group" id="spanAttachment">
										...
										<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 col-xl-6">
											...
											if ($pengajuan_dana->pengajuan_dana_attacment_1 != null || $pengajuan_dana->pengajuan_dana_attacment_1 != "") { ?>
												...
												<a href="<?= base_url('FAS/Barjas/PengajuanPengeluaranDana/ViewAttachment?file=' . $pengajuan_dana->pengajuan_dana_attacment_1) ?>" target="_blank" class="btn btn-info"><?= $pengajuan_dana->pengajuan_dana_attacment_1 ?></a>
					...
					<div class="modal-footer">
						...
						<a class="btn btn-danger" href="<?= base_url('FAS/Barjas/PengajuanPengeluaranDana/PengajuanPengeluaranDanaMenu') ?>" name="CAPTION-BATAL">Batal</a>
					</div>
					</form>
				</div>
			</div>
