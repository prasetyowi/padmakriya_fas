	...
	<div class="">
		<div class="page-title">
			<div class="title_left">
				<h3>View Draft Surat Tugas Pengiriman</h3>
			</div>
			<div style="float: right">
				...
				<a href="<?=base_url('WMS/Distribusi/DeliveryOrderDraft/approve/'.$deliveryOrderDraft['delivery_order_draft_id'])?>" class="btn-approve btn btn-danger"><i class="fa fa-thumbs-up"></i> Approve</a>
				<?php endif;?>
				<?php if ($deliveryOrderDraft['delivery_order_draft_status'] == $this->M_DeliveryOrderDraft::STATUS_DRAFT):?>
				<a href="<?=base_url('WMS/Distribusi/DeliveryOrderDraft/update/'.$deliveryOrderDraft['delivery_order_draft_id'])?>" class="btn btn-warning"><i class="fa fa-edit"></i> Update</a>
				<?php endif;?>
			</div>
		</div>
					...
					<div class="row">
						<div class="col-xs-3">
							<div class="form-group field-deliveryorderdraft-delivery_order_draft_tgl_buat_do">
								...
								<div><?=date('d-m-Y', strtotime($deliveryOrderDraft['delivery_order_draft_tgl_buat_do']))?></div>
							</div>
						</div>
						<div class="col-xs-3">
							<div class="form-group field-deliveryorderdraft-delivery_order_draft_tgl_expired_do">
								...
								<div><?=date('d-m-Y', strtotime($deliveryOrderDraft['delivery_order_draft_tgl_expired_do']))?></div>
							</div>
						</div>
						<div class="col-xs-3">
							<div class="form-group field-deliveryorderdraft-delivery_order_draft_tgl_surat_jalan">
								...
								<div><?=date('d-m-Y', strtotime($deliveryOrderDraft['delivery_order_draft_tgl_surat_jalan']))?></div>
							</div>
						</div>
						<div class="col-xs-3">
							<div class="form-group field-deliveryorderdraft-delivery_order_draft_tgl_rencana_kirim">
								...
								<div><?=date('d-m-Y', strtotime($deliveryOrderDraft['delivery_order_draft_tgl_rencana_kirim']))?></div>
							</div>
						</div>
					</div>
					<div class="row">
					...
					<div class="row">
						<div class="col-xs-6">
							<div class="form-group field-deliveryorderdraft-delivery_order_draft_tipe_pembayaran">
								...
								<div><?=$this->M_DeliveryOrderDraft->getPaymentTypeLabels($deliveryOrderDraft['delivery_order_draft_tipe_pembayaran'])?></div>
							</div>
						</div>
						<div class="col-xs-6">
							<div class="form-group field-deliveryorderdraft-delivery_order_draft_tipe_layanan">
								...
								<div><?=$this->M_DeliveryOrderDraft->getServiceTypeLabels($deliveryOrderDraft['delivery_order_draft_tipe_layanan'])?></div>
							</div>
						</div>
					</div>
				</div>
