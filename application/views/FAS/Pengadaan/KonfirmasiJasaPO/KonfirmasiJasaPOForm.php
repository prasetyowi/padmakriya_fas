	...
	<div class="">
		<div class="page-title">
			<div class="title_left">
				<h3><span name="CAPTION-KONFIRMASIJASA">Konfirmasi Jasa</span></h3>
			</div>
			<div style="float: right">
				<?php if ($Menu_Access["C"] == 1) : ?>
					<a href="<?= base_url('FAS/Pengadaan/KonfirmasiJasaPO/create') ?>" class="btn btn-primary"><i class="fa fa-plus"></i> <span name="CAPTION-ADDNEW">Buat Baru<span></a>
				<?php endif; ?>
			</div>
		</div>
					...
					<div class="form-group">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<button type="button" id="btn-search-data-kj" class="btn btn-success"><i class="fa fa-search"></i> <span name="CAPTION-CARI">Cari</span></button>
							</div>
						</div>
					</div>
					<br>
						...
						<div class="col-xs-12">
							<div class="x_content">
								<table id="table_list_data_pn" width="100%" class="table table-striped table-bordered">
									<thead>
										<tr class="bg-primary">
											<td class="text-center" style="color:white;"><label name="CAPTION-NOKJ">No. Konfirmasi Jasa</label></td>
											...
											<td class="text-center" style="color:white;"><label name="CAPTION-TANGGALPURCHASEORDER">Tanggal Purchase Order</label></td>
											<td class="text-center" style="color:white;"><label name="CAPTION-TANGGALTERIMAKONFIRMASIJASA">Tanggal Terima Konfirmasi Jasa</label></td>
