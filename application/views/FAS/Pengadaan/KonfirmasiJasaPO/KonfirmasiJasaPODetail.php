						...
						<div class="row">
							...
							<div class="col-xs-3">
								<div class="form-group field-detailpenerimaanorder-penerimaan_order_kode">
									<label class="control-label" for="detailpenerimaanorder-penerimaan_order_kode" name="CAPTION-NOPN">No Penerimaan Barang PO</label>
							...
							<div class="col-xs-3">
								<div class="form-group field-detailpenerimaanorder-penerimaan_order_kode">
									<label class="control-label" for="detailpenerimaanorder-penerimaan_order_kode" name="CAPTION-NOSO">Pilih Kode PO</label>
									<select class="input-sm form-control select2" id="detailkonfirmasijasa-purchase_order_kode" name="detailpenerimaanorder[purchase_order_kode]" readonly disabled>
							...
							<div class="col-xs-3">
								<div class="form-group field-detailpenerimaanorder-sales_id">
									...
									<select class="input-sm form-control select2" id="detailkonfirmasijasa-client_wms_id" name="detailpenerimaanorder[client_wms_id]" readonly disabled>
							...
							<div class="col-xs-3">
								<div class="form-group field-detailpenerimaanorder-sales_id">
									...
									<select class="input-sm form-control select2" id="detailkonfirmasijasa-karyawan_divisi_id" name="detailpenerimaanorder[karyawan_divisi_id]" readonly disabled>
						...
						<div class="row">
							<div class="col-xs-3">
								<div class="form-group field-detailpenerimaanorder-penerimaan_order_tgl">
									<label class="control-label" for="detailpenerimaanorder-penerimaan_order_tgl" name="CAPTION-TGLPR">Tanggal Purchase Order</label>
						...
						<div class="row">
							...
							<div class="col-xs-6">
								<div class="form-group field-detailpenerimaanorder-penerimaan_order_keterangan">
									...
									<textarea class="form-control" id="detailpenerimaanorder-penerimaan_order_keterangan" name="detailpenerimaanorder[penerimaan_order_keterangan]" value="<?= $header['purchase_order_keterangan']; ?>" readonly disabled><?= $header['purchase_order_keterangan']; ?></textarea>
								</div>
							</div>
					...
					<table class="table table-striped" id="tablebarangpoedit" style="width:100%;">
						...
						<tbody>
							...
							<?php foreach ($KJDetail as $i => $item) : ?>
								<tr id="row-<?= $i ?>">
									<td><?= $i + 1 ?></td>
									<td><?= $item['sku_barang_kode'] ?></span></td>
									<td><?= $item['sku_barang_nama_produk'] ?></td>
									<td><?= $item['sku_barang_satuan'] ?></td>
									<td><?= $item['sku_barang_kemasan']; ?></td>
									<td><?= $item['po_qty']; ?></td>
									<td><?= $item['po_sisa'] == null ? $item['po_qty'] : $item['po_sisa'] ?></td>
									<td><?= $item['po_terima'] == null ? 0 : $item['po_terima'] ?></td>
									<td><?= Round($item['po_harga']) ?></td>
									<td><?= $item['purchase_order_detail_keterangan'] ?></td>
