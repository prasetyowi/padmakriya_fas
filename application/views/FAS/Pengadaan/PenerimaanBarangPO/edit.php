	...
	<div class="">
		<div class="page-title">
			<div class="title_left">
				<h3><span name="CAPTION-BUAT">Edit</span> <span name="CAPTION-PENERIMAANQTYPOBARANG">Penerimaan Qty PO Barang</span></h3>
			</div>
						...
						<div class="row">
							...
							<div class="col-xs-3">
								<div class="form-group field-editpenerimaanorder-penerimaan_order_kode">
									...
									<input readonly="readonly" type="text" id="purchaserequest-purchase_request_kode" class="form-control" name="purchaserequest[purchase_request_kode]" autocomplete="off" value="<?= $header['penerimaan_sku_barang_kode'] ?>">
								</div>
							</div>
							<div class="col-xs-3">
								<div class="form-group field-editpenerimaanorder-penerimaan_order_kode">
									<label class="control-label" for="editpenerimaanorder-penerimaan_order_kode" name="CAPTION-NOSO">Pilih Kode PO</label>
									<select class="input-sm form-control select2" id="editpenerimaanorder-purchase_order_kode" name="editpenerimaanorder[purchase_order_kode]" readonly disabled>
						...
						<div class="row">
							<div class="col-xs-6">
								<div class="form-group field-editpenerimaanorder-penerimaan_order_keterangan">
									...
									<textarea class="form-control" id="editpenerimaanorder-penerimaan_order_keterangan" name="editpenerimaanorder[penerimaan_order_keterangan]" readonly><?= $header['purchase_order_keterangan']; ?></textarea>
								</div>
							</div>
						</div>
					</div>
			...
			<div class="x_panel">
				...
				<div style="overflow-x:auto;">
					<table class="table table-striped" id="tablebarangpoedit" style="width:100%;">
						...
						<tbody>
							<input type="hidden" id="item-count-penerimaanbarangpodetail" value="<?= count($PNDetail) ?>">
							<?php foreach ($PNDetail as $i => $item) : ?>
								<tr id="row-<?= $i ?>">
									...
									<td style="display: none;"><input type="number" class="form-control numeric" id="item-<?= $i ?>-sku_barang_harga" <?= $item['po_sisa'] === 0 ? 'disabled' : '' ?> value="<?= Round($item['po_harga']) ?>"></td>
