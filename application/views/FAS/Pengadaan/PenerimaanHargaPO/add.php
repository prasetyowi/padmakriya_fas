<div class="right_col" role="main">
	<div class="">
		<div class="page-title">
			<div class="title_left">
				<h3><span name="CAPTION-BUAT">Buat</span> <span name="CAPTION-PENERIMAANHARGAPOBARANG">Penerimaan Harga PO Barang</span></h3>
			</div>
					...
					<div class="row">
						...
						<div class="col-xs-3">
							<div class="form-group field-penerimaanorder-penerimaan_order_kode">
								...
								<select class="input-sm form-control select2" id="penerimaanorder-penerimaan_kode" name="penerimaanorder[purchase_order_kode]">
						...
						<div class="col-xs-3">
							<div class="form-group field-penerimaanorder-penerimaan_order_kode">
								...
								<input type="text" id="penerimaan-po_kode" class="form-control" readonly disabled>
							</div>
						</div>
						<div class="col-xs-3">
							<div class="form-group field-penerimaanorder-gudang_id">
								...
								<select class="input-sm form-control select2" id="penerimaanorder-gudang_id" name="penerimaanorder[gudang_id]" disabled>
					...
					<div class="row">
						...
						<div class="col-xs-3">
							<div class="form-group field-penerimaanorder-penerimaan_order_status">
								<label class="control-label" for="penerimaanorder-penerimaan_order_status" name="CAPTION-STATUSPENERIMAANQTYPO">Status Penerimaan Qty Barang PO</label>
	...
	<div class="row" id="panel-barang">
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="x_panel">
				<div class="x_title">
					<h4 class="pull-left" name="CAPTION-ORDERBARANG">Order Barang</h4>
