						...
						<tbody>
							<?php foreach ($PNDetail as $i => $item) : ?>
								<tr id="row-<?= $i + 1 ?>">
									...
									<td class=""><?= $item['penerimaan_sku_barang_detail_qty'] ?></td>
									<td class=""><?= $item['penerimaan_sku_barang_detail_qty_sisa'] ?></td>
									<!-- <td class=""><?= $item['penerimaan_sku_barang_detail_qty_terima'] ?></td> -->
									<td class=""><?= Round($item['sku_barang_harga']) ?></td>
