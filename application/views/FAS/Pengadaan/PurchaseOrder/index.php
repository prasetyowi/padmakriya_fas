	...
	<div class="">
		<div class="page-title">
			<div class="title_left">
				<h3><span name="CAPTION-PURCHASEORDER">Purchase Order</span></h3>
			</div>
								...
								<table id="table_list_data_pr" width="100%" class="table table-striped table-bordered">
									<thead>
										<tr class="bg-primary">
											...
											<!-- <td class="text-center" style="color:white;"><label name="CAPTION-TIPETRANSAKSI">Tipe Transaksi</label></td> -->
