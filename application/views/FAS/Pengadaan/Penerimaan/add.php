<div class="right_col" role="main">
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3><span name="CAPTION-BUAT">Buat</span> Penerimaan Order</h3>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-3">
                            <div class="form-group field-penerimaanorder-penerimaan_order_kode">
                                <label class="control-label" for="penerimaanorder-penerimaan_order_kode" name="CAPTION-NOPO">No Purchase Order</label>
                        ...
                        <div class="col-xs-3">
                            <div class="form-group field-penerimaanorder-penerimaan_order_kode">
                                <label class="control-label" for="penerimaanorder-penerimaan_order_kode" name="CAPTION-NOSO">Pilih Kode PO</label>
                        ...
                        <div class="col-xs-3">
                            <div class="form-group field-penerimaanorder-gudang_id">
                                <label for="penerimaanorder-gudang_id" class="control-label" name="CAPTION-TIPETRANSAKSI">Pilih Gudang</label>
                        ...
                        <div class="col-xs-3">
                            <div class="form-group field-penerimaanorder-sales_id">
                                ...
                                <select class="input-sm form-control select2" id="penerimaanorder-client_wms_id" name="penerimaanorder[client_wms_id]">
                    ...
                    <div class="row">
                        <div class="col-xs-6">
                            <div class="form-group field-penerimaanorder-penerimaan_order_keterangan">
                                ...
                                <textarea class="form-control" id="penerimaanorder-penerimaan_order_keterangan" name="penerimaanorder[penerimaan_order_keterangan]"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="row" id="panel-barang">
        <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <thead>
                            <thead>
                                <tr class="bg-primary">
                                    ...
                                    <th style="color:white;vertical-align: middle;" rowspan="2"><span name="CAPTION-ACTION">Action</span></th>
                                </tr>
                            </thead>
                        <tbody>
            ...
            <div style="float: right">
                <a href="<?= base_url('FAS/Pengadaan/penerimaanorder/penerimaanorderMenu') ?>" class="btn btn-info"><i class="fa fa-reply"></i> <span name="CAPTION-KEMBALI" style="color:white;">Kembali</span></a>
                <button class="btn-submit btn btn-success" id="btnsavepenerimaanpo"><i class="fa fa-save"></i> <span name="CAPTION-SIMPAN" style="color:white;">Simpan</span></button>
            </div>
        </div>
    </div>
</div>