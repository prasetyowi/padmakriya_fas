    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3><span name="CAPTION-PURCHASEORDER">Penerimaan Order</span></h3>
            </div>
            <div style="float: right">
                <?php if ($Menu_Access["C"] == 1) : ?>
                    <a href="<?= base_url('FAS/Pengadaan/Penerimaan/create') ?>" class="btn btn-primary"><i class="fa fa-plus"></i> <span name="CAPTION-ADDNEW">Buat Baru<span></a>
                <?php endif; ?>
            </div>
        </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-xs-3">
                                ...
                                <select class="input-sm form-control select2" id="filter-pr-perusahaan" name="filter_pr_perusahaan">
                        ...
                        <div class="col-xs-12">
                            <div class="x_content">
                                <table id="table_list_data_pr" width="100%" class="table table-striped table-bordered">
                                    <thead>
                                        <tr class="bg-primary">
                                            <td class="text-center" style="color:white;"><label name="CAPTION-SUPPLIER">Nama Supplier</label></td>
                                            ...
                                            <td class="text-center" style="color:white;"><label name="CAPTION-TGLREQUEST">Tgl Request</label></td>
