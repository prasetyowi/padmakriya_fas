        ...
        <?php foreach ($SOHeader as $header) : ?>
            ...
            <div class="row" id="panel-sku">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h4 class="pull-left" name="CAPTION-SKU">SKU</h4>
                            <div class="pull-right">
                                <button id="btn-choose-prod-delivery" class="btn btn-success" type="button"><i class="fa fa-search"></i> <span name="CAPTION-PILIHSKU" style="color:white;">Pilih SKU</span></button>
                            </div>
                            <div class="clearfix"></div>
                        </div>
                    ...
                    <div class="x_panel">
                        <div class="x_title">
                            <div class="pull-left"><button id="btn-pilih-pembayaran" class="btn btn-success" type="button" onclick="PushArraySOPayment()"><i class="fa fa-plus"></i> <span name="CAPTION-TAMBAHPEMBAYARAN" style="color:white;">Tambah Pembayaran</span></button></div>
                            <div class="clearfix"></div>
                        </div>
                    ...
                    <div style="float: right">
                        ...
                        <button class="btn-submit btn btn-success" id="btn_update_sales_order"><i class="fa fa-save"></i> <span name="CAPTION-SIMPAN" style="color:white;">Simpan</span></button>
                    </div>
                </div>
            </div>
        <?php endforeach; ?>
