									...
									<div class="row">
										...
										<div class="col-xl-2 col-lg-2 col-md-2 col-xs-12">
											<div class="form-group">
												...
												<input type="text" class="form-control" autocomplete="off" id="kodeCanvasId" onkeyup="handlerGetKodeCanvas(event)" placeholder="All" data-canvasId="all">
										...
										<div class="col-xl-2 col-lg-2 col-md-2 col-xs-12">
											<div class="form-group">
												...
												<select id="perusahaan" class="form-control select2">
													<option value="all">--<label name="CAPTION-PERUSAHAAN">Perusahaan</label> --</option>
								...
								<table id="listDataFilter" width="100%" class="table table-striped">
									<thead>
										<tr>
											...
											<th widtd="15%" class="text-center"><label>Kode Canvas</label></th>
											<th widtd="15%" class="text-center"><label>Tanggal Permintaan</label></th>
