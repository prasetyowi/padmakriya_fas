		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="row" style="margin-bottom: 30px;">
					<label for="salesFilter" class="col-sm-2 col-form-label">Sales</label>
					<div class="col-sm-10">
						<div class="row">
							<div class="col-sm-5">
								<select name="salesFilter" id="salesFilter" class="form-control select2"></select>
							</div>
							<div class="col-sm-7">
						...
						<table class="table table-striped" id="table-list-so">
							<thead>
								<tr class="bg-primary">
									...
									<th class="text-center" style="color:white;"><span>Sales</span></th>
