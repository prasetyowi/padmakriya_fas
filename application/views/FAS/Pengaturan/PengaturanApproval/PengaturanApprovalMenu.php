							...
							<div class="row">
								<div class="item form-group">
									<div class="col-xs-3">
										...
										<select class="input-sm form-control select2" id="filter_perusahaan" name="filter_perusahaan">
			...
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
					<div class="x_title">
						...
						<a class="btn btn-md btn-primary" href="<?php echo site_url('FAS/Pengaturan/PengaturanApproval/PengaturanApprovalForm'); ?>" name="CAPTION-BUATPENGATURANAPPROVAL">Buat
							Pengaturan Approval</a>
						<div class="clearfix"></div>
					</div>
					<div class="row">
							...
							<thead>
								<tr>
									...
									<th style='vertical-align:middle; text-align: center;' name="CAPTION-NAMAPARAMETER">
										Nama Parameter</th>
									<th style='vertical-align:middle; text-align: center;' name="CAPTION-NAMAPENGATURANAPPROVAL">Nama Pengaturan Approval</th>
