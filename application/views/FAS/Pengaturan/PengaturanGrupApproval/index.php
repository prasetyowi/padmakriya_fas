    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h5 name="CAPTION-FILTERPERUSAHAAN">Filter Perusahaan</h5>
                    </div>
                    <div class="x_content">
                        <div class="row">
                            <div class="col-lg-6 col-md-4 col-sm-4">
                                <div class="item form-group">
                                    <label class="col-form-label col-lg-4 col-md-4 col-sm-4 label-align" name="CAPTION-PT">
                                        Perusahaan
                                    </label>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control select2" name="client_wms" id="client_wms" required>
