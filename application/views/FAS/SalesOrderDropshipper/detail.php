                            ...
                            <div class="row">
                                <div class="col-xs-3">
                                    <div class="form-group field-salesorder-sales_order_tgl_exp">
                                        ...
                                        <input type="text" id="salesorder-sales_order_tgl_exp" class="form-control datepicker" name="salesorder[sales_order_tgl_exp]" autocomplete="off" value="<?= $header['sales_order_tgl_exp'] ?>" disabled>
                                    </div>
                                </div>
                                <div class="col-xs-3">
                                    <div class="form-group field-salesorder-sales_order_tgl_harga">
                                        ...
                                        <input type="text" id="salesorder-sales_order_tgl_harga" class="form-control datepicker" name="salesorder[sales_order_tgl_harga]" autocomplete="off" value="<?= $header['sales_order_tgl_harga'] ?>" disabled>
                                    </div>
                                </div>
                                <div class="col-xs-3">
                                    <div class="form-group field-salesorder-sales_order_tgl_sj">
                                        ...
                                        <input type="text" id="salesorder-sales_order_tgl_sj" class="form-control datepicker" name="salesorder[sales_order_tgl_sj]" autocomplete="off" value="<?= $header['sales_order_tgl_sj'] ?>" disabled>
                                    </div>
                                </div>
                                <div class="col-xs-3">
                                    <div class="form-group field-salesorder-sales_order_tgl_kirim">
                                        ...
                                        <input type="text" id="salesorder-sales_order_tgl_kirim" class="form-control datepicker" name="salesorder[sales_order_tgl_kirim]" autocomplete="off" value="<?= $header['sales_order_tgl_kirim'] ?>" disabled>
                                    </div>
                                </div>
                            </div>
                            <br />
                            <div class="row">
                                ...
                                <div class="col-xs-3">
                                    <div class="form-group field-salesorder-sales_id">
                                        ...
                                        <select id="salesorder-sales_id" class="form-control select2" name="CAPTION-SALES" onChange="GetPerusahaanBySales(this.value)" disabled>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-3">
                                    <div class="form-group field-salesorder-sales_order_who_create">
                                        ...
                                        <input readonly="readonly" type="text" id="salesorder-sales_order_approved_by" class="form-control" name="salesorder[sales_order_approved_by]" autocomplete="off" value="<?= $header['sales_order_approved_by'] ?>" disabled>
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-3">
                                    <div class="form-group field-salesorder-sales_order_tipe_ppn">
                                        ...
                                        <fieldset>
                                            <label>
                                                <input <?= $SOHeader[0]['tipe_ppn'] == 'ppn_global' ? 'checked' : '' ?> onclick="chgTipePPN(this.value)" class="radio-payment-type" type="radio" name="salesorder[sales_order_tipe_ppn]" id="salesorder-sales_order_tipe_ppn" value="0" disabled> <span name="CAPTION-PPNGLOBAL">PPN Global</span>
                                            </label>
                                        </fieldset>
                                        <fieldset>
                                            <label>
                                                <input <?= $SOHeader[0]['tipe_ppn'] == 'ppn_detail' ? 'checked' : '' ?> onclick="chgTipePPN(this.value)" class="radio-payment-type" type="radio" name="salesorder[sales_order_tipe_ppn]" id="salesorder-sales_order_tipe_ppn" value="1" disabled> <span name="CAPTION-PPNDETAIL">PPN Detail</span>
                                            </label>
                                        </fieldset>
                                    </div>
                                </div>
                        ...
                        <tbody>
                            ...
                            <?php foreach ($SODetail as $i => $item) : ?>
                                <tr id="row-<?= $i ?>">
                                    ...
                                    <td class="text-center">
                                        <span id="caption-<?= $i ?>-SalesOrderDetail-sku_harga_nett"><?= round($item['sub_total']) ?></span>
                                    </td>
                                    <td class="text-center">
