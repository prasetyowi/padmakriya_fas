        ...
        <div class="page-title">
            ...
            <div style="float: right">
                <?php if ($Menu_Access["C"] == 1) : ?>
                    ...
                    <button class="btn-submit btn btn-primary" id="btn-approv-so"><i class="fa fa-check"></i> <span name="CAPTION-APPROV">Approv</span></button>
                    <a href="<?= base_url('FAS/SalesOrderDropshipper/create') ?>" class="btn btn-primary"><i class="fa fa-plus"></i>
                                ...
                                <table id="table_list_data_so" width="100%" class="table table-striped table-bordered">
                                    <thead>
                                        <tr class="bg-primary">
                                            ...
                                            <th class="text-center" style="color:white;"><strong><label name="CAPTION-TANGGALSO">Tanggal SO</label></strong></th>
                    ...
                    <div class="row">
                        ...
                        <!-- <div class="col-xs-3">
                            ...
                            <select id="filter-status-edit" name="filter-status-edit" class="form-control" style="width: 100%;">
                                <option value="Draft"><label name="CAPTION-SEMUA">Semua</label></option>
