<div class="right_col" role="main">
	<div class="">
				...
				<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="x_panel" id="header">
						...
						<div class="row">
							...
							<input type="hidden" value="<?= $konfirmasi_hutang_id ?>" id="hpf_id" />
						...
						<div class="row">
							...
							<div class="col-xs-3">
								...
								<div class="form-group field-pemasukanfaktur-pr_is_need_approval" style="display:none">
									<input type="checkbox" disabled readonly id="pemasukanfaktur_is_need_approval" name="pemasukanfaktur[pr_is_need_approval]" autocomplete="off" value="1" <?= $header['konfirmasi_hutang_status'] != 'Draft' ? 'checked' : ''; ?>> <span name="CAPTION-PENGAJUAN">Pengajuan Approval</span>
								</div>
							</div>
						...
						<div class="row">
							<div class="col-xs-6">
								<div class="form-group field-pemasukanfaktur_keterangan">
									...
									<textarea class="form-control" id="pemasukanfaktur_keterangan" name="pemasukanfaktur[penerimaan_order_keterangan]" value="<? $header['konfirmasi_hutang_keterangan'] ?>" disabled readonly></textarea>
								</div>
							</div>
						</div>
					</div>
		...
		<div class="x_panel">
			<div class="x_title">
				<h5 name="CAPTION-ATTACHMENT"> Attachment</h5>
				<div class="clearfix"></div>
			</div>
			<div class="row">
							...
							<?php if (!empty($PNDetail)) { ?>
								<?php foreach ($PNDetail as $i => $item) : ?>
									<tr id="row-<?= $i ?>">
										...
										<td><span id="span-item-<?= $i ?>-purchase_order_detail_qty"><?= $item['penerimaan_sku_barang_detail_qty_terima'] ?></span></td>

										<td><span class="rupeah dolars-<?= $i ?>" id="span-item-<?= $i ?>-sku_barang_harga"><?= Round($item['sku_barang_harga']) ?></span></td>
										<td><span id="span-item-<?= $i ?>-purchase_order_sub_total"><?= Round($item['sku_barang_harga']) * $item['penerimaan_sku_barang_detail_qty_terima'] ?></span>
										</td>
