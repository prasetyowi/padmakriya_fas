                    ...
                    <div class="row">
                        <div class="col-xs-6">
                            <div class="form-group field-SKUKatalogSetting-sku_katalog_setting_kode">
                                ...
                                <input type="text" id="SKUKatalogSetting-sku_katalog_setting_kode" class="form-control" name="SKUKatalogSetting[sku_katalog_setting_kode]" autocomplete="off" value="">
                                <input readonly="readonly" type="hidden" id="SKUKatalogSetting-sku_katalog_setting_id" class="form-control" name="SKUKatalogSetting[sku_katalog_setting_id]" autocomplete="off" value="<?= $sku_katalog_setting_id; ?>">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xs-6">
                            <div class="form-group field-SKUKatalogSetting-sku_katalog_setting_keterangan">
                                ...
                                <input type="text" id="SKUKatalogSetting-sku_katalog_setting_keterangan" class="form-control" name="SKUKatalogSetting[sku_katalog_setting_keterangan]" autocomplete="off" value="">
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="form-group field-SKUKatalogSettingDetail-tipe_kategori1">
                                ...
                                <select name="SKUKatalogSettingDetail[tipe_kategori1]" class="input-sm form-control select2" id="SKUKatalogSettingDetail-tipe_kategori1" style="width:100%;" onchange="UpdateKategori1SKUKatalogSettingDetail(this.value)">
                                    ...
                                    <?php foreach ($KategoriGroup as $row) : ?>
                                        <option value="<?= $row['kategori_grup'] ?>"><?= $row['kategori_grup'] ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div style="float: right">
                                ...
                                <button class="btn-submit btn btn-success" id="btn_save_sku_katalog_setting"><i class="fa fa-save"></i> <span name="CAPTION-SAVE">Simpan</span></button>
