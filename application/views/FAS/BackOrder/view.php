    ...
    <div class="">
        <div class="page-title">
            ...
            <div style="float: right">
                ...
                <a href="<?= base_url('WMS/Distribusi/DeliveryOrderDraft/approve/' . $deliveryOrderDraft['delivery_order_draft_id']) ?>"
                    class="btn-approve btn btn-danger"><i class="fa fa-thumbs-up"></i> Approve</a>
                <?php endif; ?>
                <?php if ($deliveryOrderDraft['delivery_order_draft_status'] == $this->M_DeliveryOrderDraft::STATUS_DRAFT) : ?>
                <a href="<?= base_url('WMS/Distribusi/DeliveryOrderDraft/update/' . $deliveryOrderDraft['delivery_order_draft_id']) ?>"
                        ...
                        <div class="col-xs-3">
                            <div class="form-group field-deliveryorderdraft-delivery_order_draft_kode">
                                <label class="control-label"
                                    for="deliveryorderdraft-delivery_order_draft_kode"><?= (new M_DeliveryOrderDraft)->getAttributeLabels('delivery_order_draft_kode') ?></label>
                                <div><?= $deliveryOrderDraft['delivery_order_draft_kode'] ?></div>
                            </div>
                        </div>
                        <div class="col-xs-3">
                            <label class="control-label"
                                for="deliveryorderdraft-delivery_order_draft_status"><?= (new M_DeliveryOrderDraft)->getAttributeLabels('tipe_delivery_order_id') ?></label>
                            <div><?= $tipeDeliveryOrder->tipe_delivery_order_nama ?></div>
                        </div>
                        <div class="col-xs-3">
                            <div class="form-group field-deliveryorderdraft-delivery_order_draft_status">
                                <label class="control-label"
                                    for="deliveryorderdraft-delivery_order_draft_status"><?= (new M_DeliveryOrderDraft)->getAttributeLabels('delivery_order_draft_status') ?></label>
                    ...
                    <div class="row">
                        <div class="col-xs-3">
                            <div class="form-group field-deliveryorderdraft-delivery_order_draft_tgl_buat_do">
                                <label class="control-label"
                                    for="deliveryorderdraft-delivery_order_draft_tgl_buat_do"><?= (new M_DeliveryOrderDraft)->getAttributeLabels('delivery_order_draft_tgl_buat_do') ?></label>
                                <div>
                        ...
                        <div class="col-xs-3">
                            <div class="form-group field-deliveryorderdraft-delivery_order_draft_tgl_expired_do">
                                <label class="control-label"
                                    for="deliveryorderdraft-delivery_order_draft_tgl_expired_do"><?= (new M_DeliveryOrderDraft)->getAttributeLabels('delivery_order_draft_tgl_expired_do') ?></label>
                                <div>
                        ...
                        <div class="col-xs-3">
                            <div class="form-group field-deliveryorderdraft-delivery_order_draft_tgl_surat_jalan">
                                <label class="control-label"
                                    for="deliveryorderdraft-delivery_order_draft_tgl_surat_jalan"><?= (new M_DeliveryOrderDraft)->getAttributeLabels('delivery_order_draft_tgl_surat_jalan') ?></label>
                                <div>
                        ...
                        <div class="col-xs-3">
                            <div class="form-group field-deliveryorderdraft-delivery_order_draft_tgl_rencana_kirim">
                                <label class="control-label"
                                    for="deliveryorderdraft-delivery_order_draft_tgl_rencana_kirim"><?= (new M_DeliveryOrderDraft)->getAttributeLabels('delivery_order_draft_tgl_rencana_kirim') ?></label>
                                <div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6">
                            <div class="form-group field-deliveryorderdraft-delivery_order_draft_keterangan">
                                <label class="control-label"
                                    for="deliveryorderdraft-delivery_order_draft_keterangan"><?= (new M_DeliveryOrderDraft)->getAttributeLabels('delivery_order_draft_keterangan') ?></label>
                    ...
                    <div class="row">
                        <div class="col-xs-6">
                            <div class="form-group field-deliveryorderdraft-delivery_order_draft_tipe_pembayaran">
                                <label for="deliveryorderdraft-delivery_order_draft_tipe_pembayaran"
                                    class="control-label"><?= (new M_DeliveryOrderDraft)->getAttributeLabels('delivery_order_draft_tipe_pembayaran') ?></label>
                                <div>
                        ...
                        <div class="col-xs-6">
                            <div class="form-group field-deliveryorderdraft-delivery_order_draft_tipe_layanan">
                                <label for="deliveryorderdraft-delivery_order_draft_tipe_layanan"
                                    class="control-label"><?= (new M_DeliveryOrderDraft)->getAttributeLabels('delivery_order_draft_tipe_layanan') ?></label>
                                <div>
        ...
        <div <?= empty($deliveryOrderDraft['pabrik_id']) ? "style='display: none'" : "" ?> class="row"
            id="panel-factory">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                    ...
                    <table class="table table-bordered table-striped" id="table-sku-delivery-only">
                        <thead>
                            <tr>
                                ...
                                <th><?= (new M_SKU)->getAttributeLabels('sku_kode') ?> <label
                                        name="CAPTION-PABRIK">Pabrik</label></th>
                        ...
                        <tbody>
                            ...
                            <tr id="row-<?= $i ?>" class="row-item">
                                <td>
                                    <span
                                        class="sku-kode-label"><?= $item['DeliveryOrderDetailDraft']['sku_kode'] ?></span>
                                </td>
                                <td></td>
                                <td>
                                    <span
                                        class="sku-nama-produk-label"><?= $item['DeliveryOrderDetailDraft']['sku_nama_produk'] ?></span>
                                </td>
      
                          <td>
                                    <span
                                        class="sku-kemasan-label"><?= $item['DeliveryOrderDetailDraft']['sku_kemasan'] ?></span>
                                </td>
                                <td>
                                    <span
                                        class="sku-satuan-label"><?= $item['DeliveryOrderDetailDraft']['sku_satuan'] ?></span>
                                </td>
                                <td>
