                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-xs-3">
                                <div class="form-group field-backorder-back_order_kode">
                                    <label class="control-label" for="backorder-back_order_kode" name="CAPTION-NOBO">No BO</label>
                                    <input readonly="readonly" type="text" id="backorder-back_order_kode" class="form-control" name="backorder[back_order_kode]" autocomplete="off" value="">
                            ...
                            <div class="col-xs-3">
                                <div class="form-group field-backorder-back_order_no_po">
                                    ...
                                    <input type="text" class="form-control" id="backorder-back_order_no_po" name="backorder[back_order_no_po]" value="">
                                </div>
                            </div>
                            <div class="col-xs-3">
                                <div class="form-group field-backorder-tipe_back_order_id">
                                    <label class="control-label" for="backorder-tipe_back_order_id" name="CAPTION-TIPEBO">Tipe BO</label>
                                    <select name="backorder[tipe_back_order_id]" class="form-control select2" id="backorder-tipe_back_order_id">
                                        <option value="">** <label name="CAPTION-TIPEBO">Tipe BO</label> **</option>
                            ...
                            <div class="col-xs-3">
                                <div class="form-group field-backorder-tipe_delivery_order_id">
                                    ...
                                    <select name="backorder[tipe_delivery_order_id]" class="form-control select2" id="backorder-tipe_delivery_order_id">
                        ...
                        <div class="row">
                            <div class="col-xs-3">
                                <div class="form-group field-backorder-back_order_tgl">
                                    ...
                                    <input type="text" id="backorder-back_order_tgl" class="form-control datepicker" name="backorder[back_order_tgl]" autocomplete="off" value="<?= set_value('backorder[back_order_tgl_buat_do]') != "" ? set_value('backorder[back_order_tgl_buat_do]') : (isset($backorder['back_order_tgl_buat_do']) ? date('d-m-Y', strtotime($backorder['back_order_tgl_buat_do'])) : date('d-m-Y')) ?>">
                                </div>
                            </div>
                            <div class="col-xs-3">
                                <div class="form-group field-backorder-back_order_tgl_exp">
                                    ...
                                    <input type="text" id="backorder-back_order_tgl_exp" class="form-control datepicker" name="backorder[back_order_tgl_exp]" autocomplete="off" value="<?= set_value('backorder[back_order_tgl_expired_do]') != "" ? set_value('backorder[back_order_tgl_expired_do]') : (isset($backorder['back_order_tgl_expired_do']) ? date('d-m-Y', strtotime($backorder['back_order_tgl_expired_do'])) : date('d-m-Y')) ?>">
                                </div>
                            </div>
                            <div class="col-xs-2">
                                <div class="form-group field-backorder-back_order_tgl_harga">
                                    ...
                                    <input type="text" id="backorder-back_order_tgl_harga" class="form-control datepicker" name="backorder[back_order_tgl_harga]" autocomplete="off" value="<?= set_value('backorder[back_order_tgl_buat_do]') != "" ? set_value('backorder[back_order_tgl_buat_do]') : (isset($backorder['back_order_tgl_buat_do']) ? date('d-m-Y', strtotime($backorder['back_order_tgl_buat_do'])) : date('d-m-Y')) ?>">
                                </div>
                            </div>
                            <div class="col-xs-2">
                                <div class="form-group field-backorder-back_order_tgl_sj">
                                    ...
                                    <input type="text" id="backorder-back_order_tgl_sj" class="form-control datepicker" name="backorder[back_order_tgl_sj]" autocomplete="off" value="<?= set_value('backorder[back_order_tgl_sj]') != "" ? set_value('backorder[back_order_tgl_sj]') : (isset($backorder['back_order_tgl_sj']) ? date('d-m-Y', strtotime($backorder['back_order_tgl_sj'])) : "") ?>">
                                </div>
                            </div>
                            <div class="col-xs-2">
                                <div class="form-group field-backorder-back_order_tgl_kirim">
                                    ...
                                    <input type="text" id="backorder-back_order_tgl_kirim" class="form-control datepicker" name="backorder[back_order_tgl_kirim]" autocomplete="off" value="<?= set_value('backorder[back_order_tgl_rencana_kirim]') != "" ? set_value('backorder[back_order_tgl_rencana_kirim]') : (isset($backorder['back_order_tgl_rencana_kirim']) ? date('d-m-Y', strtotime($backorder['back_order_tgl_rencana_kirim'])) : "") ?>">
                                </div>
                            </div>
                        </div>
                        <br />
                        <div class="row">
                            <div class="col-xs-4">
                                ...
                                <select id="backorder-client_wms_id" name="backorder[client_wms_id]" class="form-control select2" style="width:100%;">
                            ...
                            <div class="col-xs-4">
                                ...
                                <select id="backorder-principle_id" name="backorder[principle_id]" class="form-control select2" style="width:100%;">
                                    <option value=""><label name="CAPTION-PILIH">Pilih</label></option>
                            ...
                            <div class="col-xs-4">
                                <div class="form-group field-backorder-sales_id">
                                    ...
                                    <select id="backorder-sales_id" class="form-control select2" name="CAPTION-SALES" onChange="GetPerusahaanBySales(this.value)">
                        ...
                        <div class="row">
                            <div class="col-xs-3">
                                <div class="form-group field-backorder-back_order_tipe_pembayaran">
                                    ...
                                    <fieldset>
                                        <label>
                                            <input class="radio-payment-type" type="radio" name="backorder[back_order_tipe_pembayaran]" id="backorder-back_order_tipe_pembayaran" value="0" onclick="reset_table_sku()" checked> <span name="CAPTION-TUNAI">Tunai</span>
                                        </label>
                                    </fieldset>
                                    <fieldset>
                                        <label>
                                            <input class="radio-payment-type" type="radio" name="backorder[back_order_tipe_pembayaran]" id="backorder-back_order_tipe_pembayaran" value="1" onclick="reset_table_sku()"> <span name="CAPTION-NONTUNAI">Non Tunai</span>
                                        </label>
                                    </fieldset>
                                </div>
                            </div>
                            <div class="col-xs-3">
                                <div class="form-group field-backorder-back_order_tipe_ppn">
                                    ...
                                    <fieldset>
                                        <label>
                                            <input onclick="chgTipePPN(this.value)" class="radio-payment-type" type="radio" name="backorder[back_order_tipe_ppn]" id="backorder-back_order_tipe_ppn" value="0" checked> <span name="CAPTION-PPNGLOBAL">PPN Global</span>
                                        </label>
                                    </fieldset>
                                    <fieldset>
                                        <label>
                                            <input onclick="chgTipePPN(this.value)" class="radio-payment-type" type="radio" name="backorder[back_order_tipe_ppn]" id="backorder-back_order_tipe_ppn" value="1"> <span name="CAPTION-PPNDETAIL">PPN Detail</span>
                                        </label>
                                    </fieldset>
                                </div>
                            </div>
                            <div class="col-xs-3">
                                <div class="form-group field-backorder-back_order_status">
                                    ...
                                    <input readonly="readonly" type="text" id="backorder-back_order_status" class="form-control" name="backorder[back_order_status]" autocomplete="off" value="Draft">
                                </div>
                                <!-- <div class="form-group field-backorder-so_is_need_approval">
                                    <input type="checkbox" id="backorder-so_is_need_approval" name="backorder[so_is_need_approval]" autocomplete="off" value="1"> <span name="CAPTION-PENGAJUAN">Pengajuan Approval</span>
                                </div> -->
                            </div>
                            <div class="col-xs-3">
                                <div class="form-group field-backorder-back_order_who_create">
                                    ...
                                    <input readonly="readonly" type="text" id="backorder-back_order_approved_by" class="form-control" name="backorder[back_order_approved_by]" autocomplete="off" value="">
                                </div>
                                <div class="form-group field-backorder-back_order_is_handheld">
                                    <input type="checkbox" id="backorder-back_order_is_handheld" name="backorder[back_order_is_handheld]" autocomplete="off" disabled> <span name="CAPTION-UPLOADHH">Upload dari handheld</span>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row" id="panel-customer">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <input type="hidden" name="backorder[client_pt_id]" id="backorder-client_pt_id" value="" />
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="table-responsive" style="width:100%;overflow: scroll;">
                        <table class="table table-striped" id="table-sku-delivery-only" style="width: 100%;border-collapse: collapse;">
                            <thead>
                                <tr class="bg-primary">
                                    <!-- <th class="text-center" style="color:white;text-align: center; vertical-align: middle;"><span name="CAPTION-PERUSAHAAN">Perusahaan</span></th> -->
                                    ...
                                    <th class="text-center" style="color:white;text-align: center; vertical-align: middle;"><span name="CAPTION-BRAND">Brand</span></th>
                                    <th class="text-center" style="color:white;text-align: center; vertical-align: middle;"><span name="CAPTION-SKUKODE">SKUKode</span></th>
                                    <th class="text-center" style="display:none;"></th>
                                    ...
                                    <th class="text-center" style="color:white;text-align: center; vertical-align: middle;"><span name="CAPTION-HARGA">Harga</span></th>
                                    <th class="text-center" style="color:white;text-align: center; vertical-align: middle;"><span name="CAPTION-SKUQTY">Qty</span></th>
                                    <th class="text-center" style="color:white;text-align: center; vertical-align: middle;"><span name="CAPTION-DISKONITEM">Diskon Item(%)</span></th>
                                    <th class="text-center" style="color:white;text-align: center; vertical-align: middle;"><span name="CAPTION-DISKONRUPIAH">Diskon Item(Rp)</span></th>
                                    <th class="text-center" style="color:white;text-align: center; vertical-align: middle;"><span name="CAPTION-SUBJUMLAH">Sub Jumlah</span></th>
                                    <th class="text-center" style="color:white;text-align: center; vertical-align: middle;"><span name="CAPTION-DISKONGLOBAL">Diskon Global(%)</span></th>
                                    <th class="text-center" style="color:white;text-align: center; vertical-align: middle;"><span name="CAPTION-DISKONGLOBALRUPIAH">Diskon Global(Rp)</span></th>
                                    <th class="text-center" style="color:white;text-align: center; vertical-align: middle;"><span name="CAPTION-PPN">PPN</span></th>
                                    <th class="text-center" style="color:white;text-align: center; vertical-align: middle;"><span name="CAPTION-PPN">PPN (%)</span></th>
                                    <th class="text-center" style="color:white;text-align: center; vertical-align: middle;"><span name="CAPTION-PPNRUPIAH">PPN (Rp)</span></th>
                                    <!-- <th class="text-center" style="color:white;text-align: center; vertical-align: middle;"><span name="CAPTION-ED">ED Product</span></th> -->
                                    <th class="text-center" style="color:white;text-align: center; vertical-align: middle;"><span name="CAPTION-KETERANGAN">Keterangan</span></th>
                                    <!-- <th class="text-center" style="color:white;text-align: center; vertical-align: middle;"><span name="CAPTION-TIPESTOK">Tipe Stok</span></th> -->
                                    <!-- <th class="text-center" style="color:white;text-align: center; vertical-align: middle;"><span name="CAPTION-AVAILCHECKSTATUS">Avail. Check Status</span></th> -->
                                    <th class="text-center" style="color:white;text-align: center; vertical-align: middle;">Action</th>
                                </tr>
                            </thead>
                            <tbody>
                ...
                <div class="x_panel">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <input disabled type="text" id="total_diskon_item" class="form-control" name="total_diskon_item" autocomplete="off" value="0">
                        </div>
                        <div class="col-xs-12" style="margin-top: 10px;">
                            <label name="CAPTION-Total">Total</label> <span>Rp</span>
                            <input disabled type="text" id="total_rp" class="form-control" name="total_rp" autocomplete="off" value="0">
                        </div>
                        <div class="col-xs-6" style="margin-top: 10px;">
                            <label name="CAPTION-DISKONGLOBAL">Diskon Global</label>%
                            <input onchange="chgDiskonGlobal(this.value, 'percent')" type="text" id="diskon_global_percent" class="form-control" name="diskon_global_percent" autocomplete="off" value="0">
                        </div>
                        <div class="col-xs-6" style="margin-top: 10px;">
                            <label>Rp</label>
                            <input onchange="chgDiskonGlobal(this.value, 'rupiah')" type="text" id="diskon_global_rp" class="form-control" name="diskon_global_rp" autocomplete="off" value="0">
                        </div>
                        <div class="col-xs-12" style="margin-top: 10px;">
                            <label name="CAPTION-DASARKENAPAJAK">Dasar Kena Pajak</label>
                            <input disabled type="text" id="dasar_kena_pajak" class="form-control" name="dasar_kena_pajak" autocomplete="off" value="0">
                        </div>
                        <div class="col-xs-6" style="margin-top: 10px;">
                            ...
                            <input disabled type="text" id="ppn_global_percent" class="form-control" name="ppn_global_percent" autocomplete="off" value="0">
                        </div>
                        <div class="col-xs-6" style="margin-top: 10px;">
                            <label>Rp</label>
                            <input disabled type="text" id="ppn_global_rp" class="form-control" name="ppn_global_rp" autocomplete="off" value="0">
                        </div>
                        <div class="col-xs-12" style="margin-top: 10px;">
                            <label name="CAPTION-ADJUSMENT">Adjustment</label>
                            <input onchange="triggerDetail()" type="number" id="adjustment" class="form-control" name="adjustment" autocomplete="off" value="0">
                        </div>
                        <div class="col-xs-12" style="margin-top: 10px;">
                            <label name="CAPTION-TOTALFAKTUR">Total Faktur</label>
                            <input disabled type="text" id="total_faktur" class="form-control" name="total_faktur" autocomplete="off" value="0">
                        </div>
                    </div>
                </div>
                <!-- <div style="float: right">
    ...
    <div class="modal-dialog modal-lg" style="width: 80%;">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <table class="table table-bordered" id="table-ed-sku">
                            <thead>
                                <tr class="bg-primary">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="col-xs-12">
                                ...
                                <table class="table table-bordered" id="table-ed-sku-retur">
                                    <thead>
                                        <tr class="bg-primary">
                                            <th class="text-center" style="color:white;">No</th>
                ...
                <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="col-xs-12">
                                    <table class="table table-bordered" id="table-stock-availability-check">
                                        <thead>
                                            <tr class="bg-primary">
...
<div class="modal fade" id="modal_list_data_pilih_jadwal_sku" role="dialog" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog" style="width:90%">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-success" onclick="PilihJadwal()"><i class="fas fa-plus"></i> <span name="CAPTION-PILIH">Pilih</span></button>
