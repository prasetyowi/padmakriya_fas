	...
	<div class="">
		...
		<div class="row" id="panel-sku">
			<div class="col-md-12 col-sm-12 col-xs-12">
				...
				<div style="float: right">
					<a href="<?= base_url('FAS/Schedule/AllotmentStockOrderSupervisor/AllotmentStockOrderSupervisorMenu') ?>" class="btn btn-info"><i class="fa fa-reply"></i> <span name="CAPTION-KEMBALI">Kembali</span></a>
	...
	<div class="modal-dialog modal-lg" style="width:90%;">
		<div class="modal-content">
			...
			<div class="modal-body">
					...
					<div class="row">
						<div class="col-xs-6">
							<div class="form-group field-SimulasiMpsTemp2-tahun">
								<label class="control-label" name="CAPTION-KARAYWANSUPERVISOR">Karyawan Supervisor</label>
								<input readonly="readonly" type="text" id="SimulasiMpsTemp2-karyawan_supervisor" class="form-control" name="SimulasiMpsTemp2[karyawan_supervisor]" autocomplete="off" value="" disabled>
								<input readonly="readonly" type="hidden" id="SimulasiMpsTemp2-karyawan_supervisor_id" class="form-control" name="SimulasiMpsTemp2[karyawan_supervisor_id]" autocomplete="off" value="" disabled>
							</div>
						</div>
						<div class="col-xs-6">
				...
				<div class="x_panel">
					<div class="row">
						<button class="btn btn-primary" id="btn_modal_list_data_pilih_karyawan" onclick="ViewModalListDataPilihKaryawan()"><i class="fa fa-plus"></i> <span name="CAPTION-TAMBAHKARYAWANSALES" style="color:white;">Tambah Karyawan Sales</span></button>
						...
						<table class="table table-bordered" id="table_list_karyawan_sales_simulasi_mps" style="width: 100%;">
							<thead>
								<tr>
									<th class="text-center" style="text-align: center; vertical-align: middle;">#</th>
