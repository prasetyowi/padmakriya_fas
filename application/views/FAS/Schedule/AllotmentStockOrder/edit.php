						...
						<div class="row">
							<div class="col-xs-4">
								<div class="form-group field-AllotmentStockOrder-allotment_stock_order_kode">
									...
									<input readonly="readonly" type="text" id="AllotmentStockOrder-allotment_stock_order_kode" class="form-control" name="AllotmentStockOrder[allotment_stock_order_kode]" autocomplete="off" value="<?= $header['allotment_stock_order_kode'] ?>">
									<input readonly="readonly" type="hidden" id="AllotmentStockOrder-allotment_stock_order_id" class="form-control" name="AllotmentStockOrder[allotment_stock_order_id]" autocomplete="off" value="<?= $header['allotment_stock_order_id'] ?>">
									<input readonly="readonly" type="hidden" id="AllotmentStockOrder-allotment_stock_order_tgl_update" class="form-control" name="AllotmentStockOrder[allotment_stock_order_tgl_update]" autocomplete="off" value="<?= $header['allotment_stock_order_tgl_update'] ?>">
									<input readonly="readonly" type="hidden" id="AllotmentStockOrder-allotment_stock_order_who_update" class="form-control" name="AllotmentStockOrder[allotment_stock_order_who_update]" autocomplete="off" value="<?= $header['allotment_stock_order_who_update'] ?>">
								</div>
							</div>
							<div class="col-xs-4">
								<div class="form-group field-AllotmentStockOrder-client_wms_id">
									...
									<select id="AllotmentStockOrder-client_wms_id" class="form-control select2" name="AllotmentStockOrder[client_wms_id]" onchange="GetPrincipleByPerusahaan()" disabled>
							...
							<div class="col-xs-4">
								<div class="form-group field-AllotmentStockOrder-allotment_stock_order_kode">
									...
									<input type="text" id="AllotmentStockOrder-allotment_stock_order_tahun" class="form-control" name="AllotmentStockOrder[allotment_stock_order_tahun]" autocomplete="off" value="<?= $header['allotment_stock_order_tahun'] ?>" disabled>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-xs-4">
								<div class="form-group field-AllotmentStockOrder-allotment_stock_order_keterangan">
									...
									<input type="text" id="AllotmentStockOrder-allotment_stock_order_keterangan" class="form-control" name="AllotmentStockOrder[allotment_stock_order_keterangan]" autocomplete="off" value="<?= $header['allotment_stock_order_keterangan'] ?>">
								</div>
							</div>
							<div class="col-xs-4">
								<div class="form-group field-AllotmentStockOrder-allotment_stock_order_status">
									...
									<input readonly="readonly" type="text" id="AllotmentStockOrder-allotment_stock_order_status" class="form-control" name="AllotmentStockOrder[allotment_stock_order_status]" autocomplete="off" value="<?= $header['allotment_stock_order_status'] ?>" disabled>
								</div>
							</div>
						</div>
					</div>
					...
					<table class="table table-bordered" id="table_allotment_stock_order_detail" style="width: 100%;">
						<thead>
							<tr>
								...
								<th class="text-center" style="text-align: center; vertical-align: middle;" name="CAPTION-QTYBACKORDER">Qty Back Order</th>
			...
			<div class="modal-body">
				...
				<div class="x_panel">
					<div class="row">
						...
						<div class="col-xs-4">
							<div class="form-group field-SimulasiMpsTemp2-tahun">
								<label class="control-label" name="CAPTION-KARAYWANSALES">Karyawan Sales</label>
								<input readonly="readonly" type="text" id="SimulasiMpsTemp2-karyawan_sales" class="form-control" name="SimulasiMpsTemp2[karyawan_sales]" autocomplete="off" value="ARI PURWANTO" disabled>
								<input readonly="readonly" type="hidden" id="SimulasiMpsTemp2-karyawan_sales_id" class="form-control" name="SimulasiMpsTemp2[karyawan_sales_id]" autocomplete="off" value="644A7B16-2038-4529-A0B9-EC549DD0E6BB" disabled>
								<!-- <input readonly="readonly" type="text" id="SimulasiMpsTemp2-karyawan_sales" class="form-control" name="SimulasiMpsTemp2[karyawan_sales]" autocomplete="off" value="?= $this->session->useradata('karyawan_nama') ?>" disabled>
								<input readonly="readonly" type="hidden" id="SimulasiMpsTemp2-karyawan_sales_id" class="form-control" name="SimulasiMpsTemp2[karyawan_sales_id]" autocomplete="off" value="?= $this->session->useradata('karyawan_id') ?>" disabled> -->
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-xs-4">
							<div class="form-group field-SimulasiMpsTemp2-qty">
								...
								<input type="text" id="SimulasiMpsTemp2-qty" class="form-control" name="SimulasiMpsTemp2[qty]" autocomplete="off" value="0" onchange="CekQtySisa()" disabled>
							</div>
						</div>
...
<div class="modal fade" id="modal_back_order_simulasi_mps" role="dialog" data-keyboard="false" data-backdrop="static">
	<div class="modal-dialog modal-lg" style="width:80%;">
		<div class="modal-content">
			<div class="modal-header bg-primary">
				<div class="row">
					<div class="col-lg-6 col-md-6">
						<h4 class="modal_title_back_order_simulasi_mps"></h4>
					</div>
				</div>
			</div>
			<div class="modal-body">
					...
					<div class="row">
						<div class="col-md-6 col-sm-6 col-xs-6">
							<div class="row">
								...
								<div class="col-xs-9">
									<label id="filter_sku_kode_back_order_simulasi_mps"></label>
								</div>
							</div>
							<div class="row">
								<div class="col-xs-2">
								...
								<div class="col-xs-9">
									<label id="filter_sku_nama_produk_back_order_simulasi_mps"></label>
								</div>
							</div>
						</div>
						<div class="col-md-6 col-sm-6 col-xs-6">
							<div class="row">
								...
								<div class="col-xs-9">
									<label id="filter_sku_satuan_back_order_simulasi_mps"></label>
								</div>
							</div>
							<div class="row">
								<div class="col-xs-2">
								...
								<div class="col-xs-9">
									<label id="filter_sku_kemasan_back_order_simulasi_mps"></label>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="x_panel">
					<div class="row">
						<table class="table table-bordered" id="table_list_back_order_simulasi_mps2" style="width: 100%;">
							<thead>
								<tr>
									<th class="text-center" style="text-align: center; vertical-align: middle;">#</th>
									<th class="text-center" style="text-align: center; vertical-align: middle;" name="CAPTION-KODEBACKORDER">Kode Back Order</th>
			...
			<div class="modal-footer">
				<div class="row">
					<div class="col-md-12 pull-right">
						<button type="button" class="btn btn-success" id="btn_save_back_order_simulasi_mps" onclick="SaveBackOrderSimulasiMps()"><i class="fa fa-save"></i> <span name="CAPTION-SIMPAN">Simpan</span></button>
						<button type="button" data-dismiss="modal" class="btn btn-danger"><i class="fa fa-times"></i> <span name="CAPTION-TUTUP">Tutup</span></button>
					</div>
				</div>
			</div>
