<script type="text/javascript">
	...
	function Get_allotment_stock_order_by_filter() {
		$.ajax({
			type: 'GET',
			url: "<?= base_url('FAS/Schedule/AllotmentStockOrder/Get_allotment_stock_order_by_filter') ?>",
			data: {
							...
							$("#table_list_allotment_stock_order > tbody").append(`
								<tr>
									...
									<td class="text-center" style="text-align: center; vertical-align: middle;">
										<a href="<?= base_url() ?>FAS/Schedule/AllotmentStockOrder/edit/?id=${v.allotment_stock_order_id}" class="btn btn-primary btn-sm" target="_blank"><i class="fa fa-pencil"></i></a>
									</td>
								</tr>
							`);
						});
