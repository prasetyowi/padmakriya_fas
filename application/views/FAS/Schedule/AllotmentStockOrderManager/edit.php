	...
	<div class="">
						...
						<div class="row">
							...
							<div class="col-xs-4">
								<div class="form-group field-AllotmentStockOrder-allotment_stock_order_kode">
									...
									<input type="text" id="AllotmentStockOrder-allotment_stock_order_tahun" class="form-control" name="AllotmentStockOrder[allotment_stock_order_tahun]" autocomplete="off" value="<?= $header['allotment_stock_order_tahun'] ?>">
								</div>
							</div>
						</div>
						<div class="row">
		...
		<div class="row" id="panel-sku">
			<div class="col-md-12 col-sm-12 col-xs-12">
					...
					<table class="table table-bordered" id="table_allotment_stock_order_detail" style="width: 100%;">
						<thead>
							<tr>
								...
								<!-- <th class="text-center" style="text-align: center; vertical-align: middle;" name="CAPTION-QTYBAGI">QTY Bagi</th> -->
				...
				<div style="float: right">
					<a href="<?= base_url('FAS/Schedule/AllotmentStockOrderManager/AllotmentStockOrderManagerMenu') ?>" class="btn btn-info"><i class="fa fa-reply"></i> <span name="CAPTION-KEMBALI">Kembali</span></a>
			...
			<div class="modal-body">
				...
				<div class="x_panel">
					<div class="row">
						<div class="col-xs-6">
							<div class="form-group field-SimulasiMpsTemp2-tahun">
								<label class="control-label" name="CAPTION-KARYAWANMANAGER">Karyawan Manager</label>
								<input readonly="readonly" type="text" id="SimulasiMpsTemp2-karyawan_manager" class="form-control" name="SimulasiMpsTemp2[karyawan_manager]" autocomplete="off" value="" disabled>
								<input readonly="readonly" type="hidden" id="SimulasiMpsTemp2-karyawan_manager_id" class="form-control" name="SimulasiMpsTemp2[karyawan_manager_id]" autocomplete="off" value="" disabled>
							</div>
						</div>
						<div class="col-xs-6">
							<div class="form-group field-SimulasiMpsTemp2-bulan">
								<label for="SimulasiMpsTemp2-bulan" class="control-label" name="CAPTION-DIVISI">Divisi</label>
								<input readonly="readonly" type="text" id="SimulasiMpsTemp2-divisi" class="form-control" name="SimulasiMpsTemp2[divisi]" autocomplete="off" value="" disabled>
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-xs-6">
							<div class="form-group field-SimulasiMpsTemp2-tahun">
								<label class="control-label" name="CAPTION-TAHUN">Tahun</label>
								<input readonly="readonly" type="text" id="SimulasiMpsTemp2-tahun" class="form-control" name="SimulasiMpsTemp2[tahun]" autocomplete="off" value="" disabled>
								<input type="hidden" id="SimulasiMpsTemp2-sku_id" name="SimulasiMpsTemp2[sku_id]" value="" disabled />
							</div>
						</div>
						<div class="col-xs-6">
							<div class="form-group field-SimulasiMpsTemp2-bulan">
					...
					<div class="row">
						...
						<div class="col-xs-6">
							<div class="form-group field-SimulasiMpsTemp2-qty">
								<label class="control-label" for="SimulasiMpsTemp2-qty" name="CAPTION-QTYSISA">Qty Sisa</label>
				...
				<div class="x_panel">
					<div class="row">
						<button class="btn btn-primary" id="btn_modal_list_data_pilih_karyawan" onclick="ViewModalListDataPilihKaryawan()"><i class="fa fa-plus"></i> <span name="CAPTION-TAMBAHKARYAWANSUPERVISOR" style="color:white;">Tambah Karyawan Supervisor</span></button>
						...
						<table class="table table-bordered" id="table_list_karyawan_supervisor_simulasi_mps" style="width: 100%;">
							<thead>
								<tr>
									<th class="text-center" style="text-align: center; vertical-align: middle;">#</th>
