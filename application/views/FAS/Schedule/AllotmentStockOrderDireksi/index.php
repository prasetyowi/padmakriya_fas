        ...
        <div class="page-title">
            ...
            <div style="float: right">
                <?php if ($Menu_Access["C"] == 1) : ?>
                    <a href="<?= base_url('FAS/Schedule/AllotmentStockOrderDireksi/create') ?>" class="btn btn-primary" target="_blank"><i class="fa fa-plus"></i> <span name="CAPTION-BARU">Baru</span></a>
                <?php endif; ?>
            </div>
        </div>
