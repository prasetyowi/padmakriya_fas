					...
					<div class="row">
						<div class="col-xs-4">
							<div class="form-group field-ProductionShedule-production_schedule_kode">
								...
								<input readonly="readonly" type="text" id="ProductionShedule-production_schedule_kode" class="form-control" name="ProductionShedule[production_schedule_kode]" autocomplete="off" value="">
								<input readonly="readonly" type="hidden" id="ProductionShedule-production_schedule_id" class="form-control" name="ProductionShedule[production_schedule_id]" autocomplete="off" value="">
								<input readonly="readonly" type="hidden" id="ProductionShedule-production_schedule_tgl_update" class="form-control" name="ProductionShedule[production_schedule_tgl_update]" autocomplete="off" value="">
								<input readonly="readonly" type="hidden" id="ProductionShedule-production_schedule_who_update" class="form-control" name="ProductionShedule[production_schedule_who_update]" autocomplete="off" value="">
							</div>
						</div>
						<div class="col-xs-4">
						...
						<div class="col-xs-4">
							<div class="form-group field-ProductionShedule-production_schedule_kode">
								...
								<input type="text" id="ProductionShedule-production_schedule_tahun" class="form-control" name="ProductionShedule[production_schedule_tahun]" autocomplete="off" value="<?= date('Y') ?>">
								<input type="hidden" id="ProductionShedule-production_schedule_tgl" class="form-control" name="ProductionShedule[production_schedule_tgl]" autocomplete="off" value="<?= date('Y-m-d') ?>">
							</div>
						</div>
					</div>
					<div class="row">
						...
						<div class="col-xs-4">
							<div class="form-group field-ProductionShedule-production_schedule_keterangan">
								...
								<input type="text" id="ProductionShedule-production_schedule_keterangan" class="form-control" name="ProductionShedule[production_schedule_keterangan]" autocomplete="off" value="">
							</div>
						</div>
						<div class="col-xs-4">
							<div class="form-group field-ProductionShedule-production_schedule_status">
								...
								<input readonly="readonly" type="text" id="ProductionShedule-production_schedule_status" class="form-control" name="ProductionShedule[production_schedule_status]" autocomplete="off" value="Draft" disabled>
							</div>
						</div>
					</div>
				</div>
