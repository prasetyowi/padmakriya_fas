    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3><span name="CAPTION-222006000">Mapping Pelanggan Eksternal</span></h3>
            </div>
        </div>
        <div class="clearfix"></div>
        <div class="panel panel-default">
            <div class="panel-heading"><label name="CAPTION-FILTER">Filter</label></div>
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6">
                                ...
                                <span id="loadingviewindex" style="display:none;"><i class="fa fa-spinner fa-spin"></i>
                    ...
                    <table id="tableoutletmenu" width="100%" class="table table-striped">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center"><span name="CAPTION-OUTLET">Nama Outlet</span></th>
                                <th class="text-center"><span name="CAPTION-ALAMATOUTLET">Alamat Outlet</span></th>
                                <th class="text-center"><span name="CAPTION-TELEPONOUTLET">Telepon Outlet</span></th>
    ...
    <div class="modal-dialog modal-lg" style="width:90%;">
        <div class="modal-content">
                    ...
                    <div class="col-xs-12">
                        <div class="row">
                            <div class="col-xs-4">
                                ...
                                <input readonly="readonly" type="hidden" id="filter-client_pt_id" class="form-control"
                                    value="">
                            </div>
                            <div class="col-xs-4">
                        ...
                        <div class="row">
                            <div class="col-xs-4">
                                ...
                                <select id="filter-slc_sistem_eksternal" class="selectpicker form-control"
                                    name="filter[slc_sistem_eksternal]" data-live-search="true" style="color:#000000"
                                    multiple required data-actions-box="true" title="Select System">
                                    <?php foreach ($Sistem as $row) : ?>
                                    <option value="<?= $row['sistemeksternal_nama']; ?>">
                                        <?= $row['sistemeksternal_nama']; ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                        </div>
                            ...
                            <thead>
                                <tr class="bg-primary">
                                    <th style="text-align: center; vertical-align: middle;color:white;"
                                        name="CAPTION-SISTEMEKSTERNAL">Sistem Eksternal</th>
                                    <th style="text-align: center; vertical-align: middle;color:white;"
                                        name="CAPTION-PRINCIPLE">Principle</th>
                                    <th style="text-align: center; vertical-align: middle;color:white;"
                                        name="CAPTION-CUSTOMERIDBOSNET">Customer ID Eksternal</th>
                                </tr>
                            </thead>
                            <tbody>
            ...
            <div class="modal-footer">
                <span id="loadingviewprinciple" style="display:none;"><i class="fa fa-spinner 
fa-spin"></i><label name="CAPTION-LOADING">Loading</label>...</span>
                <button type="button" class="btn btn-info" id="btnsavecustomerprinciple"><label
