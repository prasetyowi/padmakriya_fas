    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3 name="CAPTION-PENGAJUANKREDITLIMITPELANGGAN">Pengajuan Kredit Limit Pelanggan</h3>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h5 name="CAPTION-PENCARIANPENGAJUANKREDITLIMITPELANGGAN">Pencarian Pengajuan Kredit Limit
                            Pelanggan</h5>
                    </div>
                    <div class="x_content">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <div class="form-group">
                                        <label class="col-form-label col-lg-6 col-md-6 col-sm-6 label-align"
                                            name="CAPTION-TANGGAL">Tanggal
                                        </label>
                                        <div class="col-lg-6 col-md-6 col-sm-6">
                                            <input type="text" id="filter_tanggal" class="form-control"
                                                name="filter_tanggal" value="" />
                                        </div>
                                    </div>
                                ...
                                <div class="item form-group">
                                    <div class="col-md-12 col-sm-12 text-left">
                                        <a class="btn btn-md btn-primary btn-submit-filter" onclick="getDataSearch()"
                                            name="CAPTION-CARI">Cari</a>
                                    </div>
                                </div>
                        </form>
                    </div>
        ...
        <div class="row ro-batch" id="do-table">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h5 name="CAPTION-DAFTARPENGAJUANKREDITLIMITPELANGGAN">Daftar Pengajuan Kredit Limit Pelanggan
                        </h5>
                        <a class="btn btn-md btn-primary"
                            href="<?php echo site_url('FAS/ManagementPelanggan/PengaturanKreditLimit/PengaturanKreditLimitForm'); ?>"
                            name="CAPTION-BUATKREDITLIMITPELANGGAN">Buat
                            Kredit Limit Pelanggan</a>
                        <div class="clearfix"></div>
                    </div>
                    <div class="row">
                        <table id="tableKreditLimit" width="100%" class="table table-responsive">
                            <thead>
                                <tr>
                                    <th style='vertical-align:middle; text-align: center;' name="CAPTION-NO">No</th>
                                    <th style='vertical-align:middle; text-align: center;' name="CAPTION-NODOKUMEN">No
                                        Dokumen</th>
                                    <th style='vertical-align:middle; text-align: center;' name="CAPTION-TGL">Tgl</th>
                                    <th style='vertical-align:middle; text-align: center;' name="CAPTION-PELANGGAN">
                                        Pelanggan</th>
                                    <th style='vertical-align:middle; text-align: center;' name="CAPTION-ALAMAT">Alamat
                                    </th>
...
<div class="modal fade" id="modalDetail" role="dialog" data-keyboard="false" data-backdrop="static">
 ...
 <th style="text-align: center;" name="CAPTION-NODKUMEN">No Dokumen</th>
...
anel">
                        ...
                        <div class="row">
                            <div class="form-group">
                                <la bel class="control-label col-xs-12 col-sm-2 col-md-2 col-lg-2 col-xl-2"
