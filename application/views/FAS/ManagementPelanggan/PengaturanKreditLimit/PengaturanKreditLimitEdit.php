                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8 col-xl-8">
                                                ...
                                                <input type="hidden" id="add_id_kredit" name="add_id_kredit"
                                                    class="form-control"
                                                    value="<?= $kredit_limit->pengajuan_kredit_id ?>" readonly />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-xs-12 col-sm-4 col-md-4 col-lg-4 col-xl-4"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8 col-xl-8">
                                                ...
                                                <input type="hidden" name="add_id_pelanggan"
                                                    value="<?= $kredit_limit->client_pt_id ?>" id="add_id_pelanggan" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8 col-xl-8">
                                                <textarea id="add_keterangan" name="add_keterangan"
                                                    class="txtjudul form-control"><?= $kredit_limit->pengajuan_kredit_keterangan ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-8 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                                                <input type="checkbox" class="" style="width: 20px;height: 20px;"
                                                    name="chk_approval" id="chk_approval"
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="text-center"><input class="form-control" type="text"
                                                            id="segment_1" readonly
                                                            value="<?= $kredit_limit_pelanggan->nama_segmen1 ?>"></td>
                                                    <td class="text-center"><input class="form-control" type="text"
                                                            id="segment_2" readonly
                                                            value="<?= $kredit_limit_pelanggan->nama_segmen2 ?>"></td>
                                                    <td class="text-center"><input class="form-control" type="text"
                                                            id="segment_3" readonly
                                                            value="<?= $kredit_limit_pelanggan->nama_segmen3 ?>"></td>
                                                </tr>
                                            </tbody>
                                        </table>
        ...
        <form class="form-horizontal" enctype="multipart/form-data" id="e">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a class="btn btn-success" title="Save" onclick="addDetail()" name="CAPTION-SIMPAN">>
                        Simpan</a>
