<div class="right_col" role="main">
    <div class="">
        ...
        <?php foreach ($PromoHeader as $header) : ?>
            <div class="row">
                        ...
                        <div class="row">
                            <div class="col-xs-6">
                                <div class="form-group field-SKUPromo-sku_promo_kode">
                                    ...
                                    <input readonly="readonly" type="text" id="SKUPromo-sku_promo_kode" class="form-control" name="SKUPromo[sku_promo_kode]" autocomplete="off" value="<?= $header['sku_promo_kode']; ?>">
                                    <input readonly="readonly" type="hidden" id="SKUPromo-sku_promo_id" class="form-control" name="SKUPromo[sku_promo_id]" autocomplete="off" value="<?= $header['sku_promo_id']; ?>">
                                    <input readonly="readonly" type="hidden" id="SKUPromo-sku_promo_id_new" class="form-control" name="SKUPromo[sku_promo_id_new]" autocomplete="off" value="<?= $sku_promo_id_new; ?>">
                            ...
                            <div class="col-xs-6">
                                <div class="form-group field-SKUPromo-sku_promo_keterangan">
                                    ...
                                    <input disabled type="text" id="SKUPromo-sku_promo_keterangan" class="form-control" name="SKUPromo[sku_promo_keterangan]" autocomplete="off" value="<?= $header['sku_promo_keterangan']; ?>">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xs-6">
                                <div class="form-group field-SKUPromo-depo_group_id">
                                    ...
                                    <textarea class="form-control" name="" id="" disabled><?= $DepoGroupNama ?></textarea>
                                </div>
                            </div>
                            <div class="col-xs-6">
                                <div class="form-group field-SKUPromo-depo_id">
                                    ...
                                    <textarea class="form-control" name="" id="" disabled><?= $Depo ?></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xs-6">
                                <div class="form-group field-SKUPromo-sku_promo_kode">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-6">
                                            <input disabled type="text" id="SKUPromo-sku_promo_tgl_berlaku_awal" class="form-control input-sm datepicker" name="SKUPromo[sku_promo_tgl_berlaku_awal]" autocomplete="off" value="<?= $header['sku_promo_tgl_berlaku_awal']; ?>">
                                        </div>
                                        <div class="col-xs-6">
                                            <input disabled type="text" id="SKUPromo-sku_promo_tgl_berlaku_akhir" class="form-control input-sm datepicker" name="SKUPromo[sku_promo_tgl_berlaku_akhir]" autocomplete="off" value="<?= $header['sku_promo_tgl_berlaku_akhir']; ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-6">
                                <div class="form-group field-SKUPromo-sku_promo_status">
                                    ...
                                    <input readonly="readonly" type="text" id="SKUPromo-sku_promo_status" class="form-control" name="SKUPromo[sku_promo_status]" autocomplete="off" value="<?= $header['sku_promo_status'] ?>">
                                </div>
                                <!-- <div class="form-group field-SKUPromo-sku_promo_is_need_approval">
                                    <input type="checkbox" id="SKUPromo-sku_promo_is_need_approval" name="SKUPromo[sku_promo_is_need_approval]" autocomplete="off" value="1" <?= $header['sku_promo_status'] != "Draft" ? 'checked' : '' ?>> <span name="CAPTION-PENGAJUAN">Pengajuan Approval</span>
                                </div> -->
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xs-6">
                                ...
                                <select disabled name="headerPerusahaan" class="input-sm form-control select2" id="headerPerusahaan" style="width:100%;">
                                    <option value=""><?= $header['client_wms_nama'] ?></option>
                                </select>
                            </div>
                            <div class="col-xs-6" style="margin-top: 20px">
                                <div class="form-group field-SKUPromo-sku_promo_is_need_approval">
                                    <input disabled type="checkbox" id="SKUPromo-sku_promo_is_need_approval" name="SKUPromo[sku_promo_is_need_approval]" autocomplete="off" value="1" <?= $header['sku_promo_status'] != "Draft" ? 'checked' : '' ?>> <span name="CAPTION-PENGAJUAN">Pengajuan Approval</span>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xs-6">
                                <div class="form-group field-SKUPromo-depo_group_id">
                                    ...
                                    <textarea class="form-control" name="" id="" disabled><?= $Segmen ?></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h3><span name="CAPTION-PELANGGAN">Pelanggan</span></h3>
                            <div class="clearfix"></div>
                        </div>
                        <table id="table-data-customer" width="100%" class="table table-striped table-bordered">
                            <thead>
                                <tr class="bg-primary">
                                    <td class="text-center" style="color:white;">#</td>
                                    <td class="text-center" style="color:white;"><span name="CAPTION-PELANGGAN">Pelanggan</span></td>
                                    <td class="text-center" style="color:white;"><span name="CAPTION-KELURAHAN">Kelurahan</span></td>
                                    <td class="text-center" style="color:white;"><span name="CAPTION-KECAMATAN">Kecamatan</span></td>
                                    <td class="text-center" style="color:white;"><span name="CAPTION-KOTA">Kota</span></td>
                                    <td class="text-center" style="color:white;"><span name="CAPTION-PROVINSI">Provinsi</span></td>
                                </tr>
                            </thead>
                            <tbody>
                                <?php foreach ($Customer as $key => $value) : ?>
                                    <tr>
                                        ...
                                        <td class="text-center"><?= $value['client_pt_nama'] ?></td>
                                        <td class="text-center"><?= $value['client_pt_kelurahan'] ?></td>
                                        <td class="text-center"><?= $value['client_pt_kecamatan'] ?></td>
                                        <td class="text-center"><?= $value['client_pt_kota'] ?></td>
                                        <td class="text-center"><?= $value['client_pt_propinsi'] ?></td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
                        </table>
                                ...
                                <div class="col-xs-12">
                                    <table class="table table-bordered" id="table-pengaturan-header-by-sku" style="width: 50%;">
                                        <thead>
                                            <tr>
                                                <th style="vertical-align:middle; text-align:center;">#</th>
                                                <th style="vertical-align:middle; text-align:center;"><span name="CAPTION-QTYMINIMUM">Qty Minimum</span></th>
                                                <th style="vertical-align:middle; text-align:center;"><span name="CAPTION-BERKELIPATAN">Berkelipatan</span></th>
                                                <th style="vertical-align:middle; text-align:center;">Action</th>
                                            </tr>
                                        </thead>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-4">
                                    <div class="form-group field-FilterPencarianSKU-principle_id">
                                        ...
                                        <select name="FilterPencarianSKU[principle_id]" class="input-sm form-control select2" id="FilterPencarianSKU-principle_id" style="width:100%;" disabled>
                                ...
                                <div class="col-xs-4">
                                    <div class="form-group field-FilterPencarianSKU-kode_sku_wms">
                                        <label class="control-label" for="FilterPencarianSKU-kode_sku_wms" name="CAPTION-LOKASIKERJA">Kode SKU WMS</label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-4">
                                    <div class="form-group field-FilterPencarianSKUDetail1-principle_id">
                                        ...
                                        <select name="FilterPencarianSKUDetail1[principle_id]" class="input-sm form-control select2" id="FilterPencarianSKUDetail1-principle_id" style="width:100%;" disabled>
                                            <option value="">** <span name="CAPTION-All">All</span> **</option>
                                            <?php foreach ($Principle as $row) : ?>
                                                <option value="<?= $row['principle_id'] ?>"><?= $row['principle_kode'] ?></option>
                                            <?php endforeach; ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-4">
                                    <div class="form-group field-FilterPencarianSKUPengecualian-principle_id">
                                        ...
                                        <select name="FilterPencarianSKUPengecualian[principle_id]" class="input-sm form-control select2" id="FilterPencarianSKUPengecualian-principle_id" style="width:100%;" disabled>
                                            <option value="">** <span name="CAPTION-All">All</span> **</option>
                                            <?php foreach ($Principle as $row) : ?>
                                                <option value="<?= $row['principle_id'] ?>"><?= $row['principle_kode'] ?></option>
                                            <?php endforeach; ?>
