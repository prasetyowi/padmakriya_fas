                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-6">
                                <div class="form-group field-SKUPromo-sku_promo_keterangan">
                                    ...
                                    <input type="text" id="SKUPromo-sku_promo_keterangan" class="form-control" name="SKUPromo[sku_promo_keterangan]" autocomplete="off" value="<?= $header['sku_promo_keterangan']; ?>">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xs-6">
                                <div class="form-group field-SKUPromo-depo_group_id">
                                    ...
                                    <select id="SKUPromo-depo_group_id" class="selectpicker form-control" name="SKUPromo[depo_group_id]" data-live-search="true" style="color:#000000" multiple required data-actions-box="true" title="Select Group Workplace">
                                        <?php foreach ($DepoGroup2 as $row) : ?>
                                            <option value="'<?= $row['depo_group_nama'] ?>'" <?= $row['depo_group_nama_promo'] > 0 ? 'selected' : '' ?>><?= $row['depo_group_nama'] ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                            </div>
                            <div class="col-xs-6">
                                <div class="form-group field-SKUPromo-depo_id">
                                    ...
                                    <select id="SKUPromo-depo_id" class="selectpicker form-control" name="SKUPromo[depo_id]" data-live-search="true" style="color:#000000" multiple required data-actions-box="true" title="Select Workplace">
                                        <?php foreach ($Depo2 as $row) : ?>
                                            <option value="'<?= $row['depo_id'] ?>'" <?= $row['depo_id'] == $row['depo_promo_id'] ? 'selected' : '' ?>><?= $row['depo_nama'] ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-xs-6">
                                <div class="form-group field-SKUPromo-sku_promo_kode">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-6">
                                            <input type="text" id="SKUPromo-sku_promo_tgl_berlaku_awal" class="form-control input-sm datepicker" name="SKUPromo[sku_promo_tgl_berlaku_awal]" autocomplete="off" value="<?= $header['sku_promo_tgl_berlaku_awal']; ?>">
                                        </div>
                                        <div class="col-xs-6">
                                            <input type="text" id="SKUPromo-sku_promo_tgl_berlaku_akhir" class="form-control input-sm datepicker" name="SKUPromo[sku_promo_tgl_berlaku_akhir]" autocomplete="off" value="<?= $header['sku_promo_tgl_berlaku_akhir']; ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group field-SKUPromo-depo_group_nama">
                                    ...
                                    <select id="SKUPromo-client_pt_segmen" class="selectpicker form-control" name="SKUPromo[client_pt_segmen]" data-live-search="true" style="color:#000000" multiple required data-actions-box="true" title="Select Group Workplace" onchange="GetPelangganBySegmen()">
                                        <?php foreach ($Segmen1 as $row) : ?>
                                            <option value="'<?= $row['client_pt_segmen_id'] ?>'" <?= $row['client_pt_segmen_id'] == $row['client_pt_segmen_id_promo'] ? 'selected' : '' ?>><?= $row['client_pt_segmen_kode'] . " - " . $row['client_pt_segmen_nama'] ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                                <div class="form-group field-SKUPromo-sku_promo_is_khusus">
                                    <input type="checkbox" id="SKUPromo-sku_promo_is_khusus" name="SKUPromo[sku_promo_is_khusus]" autocomplete="off" value="1" <?= $header['is_khusus'] == '1' ? 'checked' : '' ?>> <span name="CAPTION-KHUSUS">Khusus</span>
                                </div>
                            </div>
                            <div class="col-xs-6">
                                <div class="form-group field-SKUPromo-client_pt_id">
                                    ...
                                    <span id="loadingdepo" style="display:none;"><i class="fa fa-spinner fa-spin"></i> Loading...</span>
                                    <select id="SKUPromo-client_pt_id" class="selectpicker form-control" name="SKUPromo[client_pt_id]" data-live-search="true" style="color:#000000" multiple required data-actions-box="true" title="Select Pelanggan" <?= $header['is_khusus'] == '1' ? '' : 'disabled' ?>>
                                        <?php foreach ($Customer as $row) : ?>
                                            <option value="'<?= $row['client_pt_id'] ?>'" <?= $row['client_pt_id'] == $row['client_pt_id_promo'] ? 'selected' : '' ?>><?= $row['client_pt_nama'] . " - " . $row['client_pt_kelurahan'] ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                            </div>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div style="float: right">
                    ...
                    <a href="<?= base_url('FAS/MasterPricing/promoDanPromo/Promo/PromoMenu') ?>" class="btn btn-info"><i class="fa fa-reply"></i> <span name="CAPTION-KEMBALI">Kembali</span></a>
                </div>
            </div>
        </div>
    </div>
