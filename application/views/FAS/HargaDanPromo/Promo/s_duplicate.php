<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $.ajax({
            type: 'POST',
            url: "<?= base_url('FAS/MasterPricing/HargaDanPromo/Promo/proses_duplicate_sku_promo') ?>",
            data: {
            ...
            success: function(response) {
                ...
                if (response.length > 0) {
                    ...
                    $.each(response, function(i, v) {
                        if (v.ErrorMessage == "") {
                            console.log("duplicate_sku_promo success");
                            Swal.close();
            ...
            Swal.fire({
                ...
                if (result.value == true) {
                    ...
                    $.ajax({
                        async: false,
                        type: 'POST',
                        url: "<?= base_url('FAS/MasterPricing/HargaDanPromo/Promo/duplicate_sku_promo') ?>",
                        data: {
                            sku_promo_id: $("#SKUPromo-sku_promo_id").val(),
