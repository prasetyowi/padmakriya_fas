						...
						<div class="row">
							<div class="col-xs-6">
								<div class="form-group field-SKUHarga-sku_harga_kode">
									...
									<input <?= $header['sku_harga_id_before'] != "" || $header['sku_harga_id_before'] != "null" ? 'readonly' : '' ?> type="text" id="SKUHarga-sku_harga_kode" class="form-control" name="SKUHarga[sku_harga_kode]" autocomplete="off" value="<?= $header['sku_harga_kode'] ?>">
									...
									<input type="hidden" id="SKUHarga-sku_harga_id_before" class="form-control" name="SKUHarga[sku_harga_id_before]" autocomplete="off" value="<?= $header['sku_harga_id_before'] ?>">
								</div>
							</div>
							<div class="col-xs-6">
						...
						<div class="row">
							<div class="col-xs-6">
								...
								<div class="form-group field-SKUHarga-sku_harga_is_need_approval">
									<input type="checkbox" id="SKUHarga-sku_harga_is_need_approval" name="SKUHarga[sku_harga_is_need_approval]" autocomplete="off" value="1" <?= $header['sku_harga_status'] != 'Draft' ? 'checked' : '' ?>> <span name="CAPTION-PENGAJUAN">Pengajuan Approval</span>
								</div>
							</div>
							<div class="col-xs-6">
