                    ...
                    <div class="row">
                        <div class="col-xs-6">
                            <div class="form-group field-SKUHarga-sku_harga_kode">
                                ...
                                <input type="text" id="SKUHarga-sku_harga_kode" class="form-control" name="SKUHarga[sku_harga_kode]" autocomplete="off" value="">
                            </div>
                        </div>
                        <div class="col-xs-6">
                    ...
                    <div class="row">
                        <div class="col-xs-6">
                            <div class="form-group field-SKUHarga-depo_group_nama">
                                ...
                                <select onchange="chgLokasiKerja(this.value)" id="SKUHarga-depo_group_nama" class="selectpicker form-control" name="SKUHarga[depo_group_nama]" data-live-search="true" style="color:#000000" multiple required data-actions-box="true" title="Select Group Workplace">
                    ...
                    <div class="row">
                        <div class="col-xs-6">
                            <div class="form-group field-SKUHarga-sku_harga_kode">
                                ...
                                <div class="row">
                                    <div class="col-xs-6">
                                        <input type="text" id="SKUHarga-sku_harga_startdate" class="form-control input-sm datepicker" name="SKUHarga[sku_harga_startdate]" autocomplete="off" value="<?= date('d-m-Y') ?>">
                                    </div>
                                    <div class="col-xs-6">
                                        <input type="text" id="SKUHarga-sku_harga_enddate" class="form-control input-sm datepicker" name="SKUHarga[sku_harga_enddate]" autocomplete="off" value="<?= date('d-m-Y') ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-6">
                            <div class="form-group field-SKUHarga-sku_harga_keterangan">
                                ...
                                <input type="text" id="SKUHarga-sku_harga_keterangan" class="form-control" name="SKUHarga[sku_harga_keterangan]" autocomplete="off" value="">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-xs-6">
                            <div class="form-group field-SKUHarga-sku_harga_who_create">
                                ...
                                <input readonly="readonly" type="text" id="SKUHarga-sku_harga_approved_by" class="form-control" name="SKUHarga[sku_harga_approved_by]" autocomplete="off" value="">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xs-6">
                            ...
                            <div class="form-group field-SKUHarga-sku_harga_is_khusus">
                                <input type="checkbox" id="SKUHarga-sku_harga_is_khusus" name="SKUHarga[sku_harga_is_khusus]" autocomplete="off" value="1"> <span name="CAPTION-KHUSUS">Khusus</span>
                            </div>
                        </div>
                        <div class="col-xs-6">
                    ...
                    <table class="table table-striped" id="table-input-harga" style="width:100%;">
                        <thead>
                            <tr class="bg-primary">
                                ...
                                <th class="text-center" style="color:white;"><input type="checkbox" name="select-sku" id="select-with-tax" value="1"> <span name="CAPTION-DENGANPAJAK">Dengan Pajak</span></th>
