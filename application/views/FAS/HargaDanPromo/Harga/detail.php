                        ...
                        <div class="row">
                            <div class="col-xs-6">
                                <div class="form-group field-SKUHarga-sku_harga_kode">
                                    ...
                                    <input <?= $header['sku_harga_status'] != 'Draft' ? 'readonly="readonly"' : '' ?> type="text" id="SKUHarga-sku_harga_kode" class="form-control" name="SKUHarga[sku_harga_kode]" autocomplete="off" value="<?= $header['sku_harga_kode'] ?>">
                            ...
                            <div class="col-xs-6">
                                <div class="form-group field-SKUHarga-client_wms_id">
                                    ...
                                    <select name="SKUHarga[client_wms_id]" class="form-control select2" id="SKUHarga-client_wms_id" disabled>
                        ...
                        <div class="row">
                            <div class="col-xs-6">
                                <div class="form-group field-SKUHarga-depo_group_nama">
                                    ...
                                    <select id="SKUHarga-depo_group_nama" class="selectpicker form-control" name="SKUHarga[depo_group_nama]" data-live-search="true" style="color:#000000" multiple required data-actions-box="true" title="Select Group Workplace" disabled>
                            ...
                            <div class="col-xs-6">
                                <div class="form-group field-SKUHarga-depo_id">
                                    ...
                                    <select id="SKUHarga-depo_id" class="selectpicker form-control" name="SKUHarga[depo_id]" data-live-search="true" style="color:#000000" multiple required data-actions-box="true" title="Select Group Workplace" disabled>
                        ...
                        <div class="row">
                            <div class="col-xs-6">
                                <div class="form-group field-SKUHarga-sku_harga_kode">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-6">
                                            <input type="text" id="SKUHarga-sku_harga_startdate" class="form-control input-sm datepicker" name="SKUHarga[sku_harga_startdate]" autocomplete="off" value="<?= date('d-m-Y', strtotime($header['sku_harga_startdate'])) ?>" disabled>
                                        </div>
                                        <div class="col-xs-6">
                                            <input type="text" id="SKUHarga-sku_harga_enddate" class="form-control input-sm datepicker" name="SKUHarga[sku_harga_enddate]" autocomplete="off" value="<?= date('d-m-Y', strtotime($header['sku_harga_enddate'])) ?>" disabled>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-6">
                                <div class="form-group field-SKUHarga-sku_harga_keterangan">
                                    ...
                                    <input type="text" id="SKUHarga-sku_harga_keterangan" class="form-control" name="SKUHarga[sku_harga_keterangan]" autocomplete="off" value="<?= $header['sku_harga_keterangan'] ?>" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xs-6">
                                <div class="form-group field-SKUHarga-sku_harga_status">
                                    ...
                                    <input readonly="readonly" type="text" id="SKUHarga-sku_harga_status" class="form-control" name="SKUHarga[sku_harga_status]" autocomplete="off" value="<?= $header['sku_harga_status'] ?>">
                                </div>
                                <div class="form-group field-SKUHarga-sku_harga_is_need_approval">
                                    <input type="checkbox" id="SKUHarga-sku_harga_is_need_approval" name="SKUHarga[sku_harga_is_need_approval]" autocomplete="off" value="1" <?= $header['sku_harga_status'] != 'Draft' ? 'checked' : '' ?> disabled> <span name="CAPTION-PENGAJUAN">Pengajuan Approval</span>
                                </div>
                            </div>
                            <div class="col-xs-6">
                                <div class="form-group field-SKUHarga-sku_harga_who_create">
                                    ...
                                    <input readonly="readonly" type="text" id="SKUHarga-sku_harga_approved_by" class="form-control" name="SKUHarga[sku_harga_approved_by]" autocomplete="off" value="<?= $header['sku_harga_who_approve'] ?>">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xs-6">
                                <div class="form-group field-SKUHarga-depo_group_nama">
                                    ...
                                    <select id="SKUHarga-client_pt_segmen" class="selectpicker form-control" name="SKUHarga[client_pt_segmen]" data-live-search="true" style="color:#000000" multiple required data-actions-box="true" title="Select Group Workplace" disabled>
                                ...
                                <div class="form-group field-SKUHarga-sku_harga_is_khusus">
                                    <input type="checkbox" id="SKUHarga-sku_harga_is_khusus" name="SKUHarga[sku_harga_is_khusus]" autocomplete="off" value="1" <?= $header['is_khusus'] == '1' ? 'selected' : '' ?> disabled> <span name="CAPTION-KHUSUS">Khusus</span>
                                </div>
                            </div>
                            <div class="col-xs-6">
                                <div class="form-group field-SKUHarga-client_pt_id">
                                    ...
                                    <span id="loadingdepo" style="display:none;"><i class="fa fa-spinner fa-spin"></i> Loading...</span>
                                    <select id="SKUHarga-client_pt_id" class="selectpicker form-control" name="SKUHarga[client_pt_id]" data-live-search="true" style="color:#000000" multiple required data-actions-box="true" title="Select Pelanggan" disabled>
        ...
        <div class="row" id="panel-sku">
            <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <tbody>
                            <?php foreach ($HargaDetail as $key => $detail) : ?>
                                <tr id="row-<?= $key ?>">
                                    ...
                                    <td class="text-center">
                                        <input type="checkbox" id="item-<?= $key ?>-SKUHargaDetail-sku_with_tax" value="1" <?= $detail['sku_with_tax'] == '1' ? 'checked' : '' ?> disabled />
                                    </td>
                                    <td class="text-center">
                                        <?= format_rupiah($detail['sku_nominal_harga']) ?>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
                ...
                <div style="float: right">
                    ...
                    <button class="btn-submit btn btn-success" id="btnupdate"><i class="fa fa-save"></i> <span name="CAPTION-SIMPAN" style="color:white;">Simpan</span></button>
                </div>
            </div>
        </div>
    </div>
