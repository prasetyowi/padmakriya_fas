...
?>
    ...
    <!-- timepicker -->
    <script src="<?php echo base_url(); ?>vendors/less/less.min.js"></script>
    <script src="<?php echo base_url(); ?>vendors/bootstrap-timepicker/js/bootstrap-timepicker.js"></script>
