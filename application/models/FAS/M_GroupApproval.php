...
class M_GroupApproval extends CI_Model
{
	...
	public function getApprovalGrup($client)
	{
		if ($client == '') {
			$data = $this->db->select("*")
				->from('approval_group')
	...
	public function getKaryawan($client)
	{
	...
	public function saveGroup($grup_id, $client_wms, $depo_id, $nama, $keterangan, $is_aktif, $tgl_create, $who_create)
	{
