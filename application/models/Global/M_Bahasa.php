...
class M_Bahasa extends CI_Model
{
	...
	public function Getbahasa_all( $bahasa )
	{
		$this->db	->select("bahasa_id, bahasa_kode, bahasa_nama, bahasa_nama_IND, bahasa_nama_ENG", FALSE)
					->from("bahasa");
		$query = $this->db->get();
	...
	public function Getbahasa_by_bahasa_kode( $bahasa_kode, $bahasa )
	{
		$this->db	->select("bahasa_id, bahasa_kode, bahasa_nama, bahasa_nama_". $bahasa ." as bahasa", FALSE)
					->from("bahasa")
					->where("bahasa_kode", $bahasa_kode);
		$query = $this->db->get();
