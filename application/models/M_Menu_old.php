	...
	public function GetMenu_Sidebar($currentpage,$pengguna_grup_id,$menuparent="",$awalan=""){
		...
		foreach($resultMenu as $rowMenu)
		{
			...
			if($menuparent == "")
			{
				...
				{
					if($rowMenu["menu_link"] != "#sidebar-menu"){
						$menu .= "<li ".( $currentpage == $awalan.$menuname?' class="current-page" ':'' )."><a href=\"".base_url($rowMenu["menu_link"])."\" onclick='ShowTreeMenu(\"".$rowMenu["menu_kode"]."\",\"".$rowMenu["menu_parent"]."\")'><i class=\"".$rowMenu["menu_class"]."\"></i><label name='CAPTION-". $rowMenu["menu_kode"] ."'>".$rowMenu["menu_name"]."</label> </a>";
					}
					else{
						$menu .= "<li ".( $currentpage == $awalan.$menuname?' class="current-page" ':'' )."><a href=\"".$rowMenu["menu_link"]."\" onclick='ShowTreeMenu(\"".$rowMenu["menu_kode"]."\",\"".$rowMenu["menu_parent"]."\")'><i class=\"".$rowMenu["menu_class"]."\"></i> <label name='CAPTION-". $rowMenu["menu_kode"] ."'>".$rowMenu["menu_name"]."</label> </a>";
					}
					
				}
				else
				{
					$menu .= "<li ".(substr($currentpage,0,strlen($awalan.$menuname)) == $awalan.$menuname ?' class="active" ':'')."><a onclick='ShowTreeMenu(\"".$rowMenu["menu_kode"]."\",\"".$rowMenu["menu_parent"]."\")'><i class=\"".$rowMenu["menu_class"]."\"></i> <label name='CAPTION-". $rowMenu["menu_kode"] ."'>".$rowMenu["menu_name"]."</label> <span class=\"fa fa-chevron-down\"></span></a>";
			...
			else
			{
				...
				{					
					if($rowMenu["menu_link"] != "#sidebar-menu"){
						$menu .= "<li ".($currentpage == $awalan.$menuname?' class="current-page" ':'')."><a href=\"".$rowMenu["menu_kode"]."\"".base_url($rowMenu["menu_link"])."\" name='onclick='ShowTreeMenu(\"".$rowMenu["menu_kode"]."\",\"".$rowMenu["menu_parent"]."\")'><i class=\"".$rowMenu["menu_class"]."\"></i> <label name='CAPTION-". $rowMenu["menu_kode"] ."'>".$rowMenu["menu_name"]."</label> </a>";
					}
					else{						
						$menu .= "<li ".($currentpage == $awalan.$menuname?' class="current-page" ':'')."><a href=\"".$rowMenu["menu_link"]."\" onclick='ShowTreeMenu(\"".$rowMenu["menu_kode"]."\",\"".$rowMenu["menu_parent"]."\")'><i class=\"".$rowMenu["menu_class"]."\"></i> <label name='CAPTION-". $rowMenu["menu_kode"] ."'>".$rowMenu["menu_name"]."</label> </a>";
					}
